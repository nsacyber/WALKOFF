...
def read_all_devices():
    @jwt_required
    @roles_accepted_for_resources(ResourcePermissions('devices', ['read']))
    def __func():
...
def delete_device(device_id):
    @jwt_required
    @roles_accepted_for_resources(ResourcePermissions('devices', ['delete']))
    def __func():
...
def create_device():
    @jwt_required
    @roles_accepted_for_resources(ResourcePermissions('devices', ['create']))
    def __func():
...
def update_device():
    @jwt_required
    @roles_accepted_for_resources(ResourcePermissions('devices', ['update']))
    def __func():
