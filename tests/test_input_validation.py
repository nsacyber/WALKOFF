...
class TestInputValidation(unittest.TestCase):
    ...
    def test_validate_parameter_primitive_no_formats_not_required_valid_string(self):
        ...
        value = 'test string'
        self.assertEqual(validate_parameter(value, parameter_api, 'app1', 'action1'), value)
        value = ''
        self.assertEqual(validate_parameter(value, parameter_api, 'app1', 'action1'), value)
    ...
    def test_validate_parameter_primitive_no_formats_not_required_valid_number(self):
        ...
        value = '3.27'
        self.assertEqual(validate_parameter(value, parameter_api, 'app1', 'action1'), 3.27)
    ...
    def test_validate_parameter_primitive_no_formats_not_required_valid_int(self):
        ...
        value = '3'
        self.assertEqual(validate_parameter(value, parameter_api, 'app1', 'action1'), 3)
    ...
    def test_validate_parameter_primitive_no_formats_not_required_valid_bool(self):
        ...
        for true_value in true_values:
            self.assertEqual(validate_parameter(true_value, parameter_api, 'app1', 'action1'), True)
        for false_value in false_values:
            self.assertEqual(validate_parameter(false_value, parameter_api, 'app1', 'action1'), False)
    ...
    def test_validate_parameter_primitive_no_formats_required_none(self):
        ...
        for parameter_api in parameter_apis:
            with self.assertRaises(InvalidStepInput):
                validate_parameter(None, parameter_api, 'app1', 'action1')
    ...
    def test_validate_parameter_primitive_not_required_none(self):
        ...
        for parameter_api in parameter_apis:
            self.assertIsNone(validate_parameter(None, parameter_api, 'app1', 'action1'))

    def test_validate_parameter_primitive_no_formats_invalid_number(self):
        parameter_api = {'name': 'name1', 'type': 'number'}
        value = 'abc'
        with self.assertRaises(InvalidStepInput):
            validate_parameter(value, parameter_api, 'app1', 'action1')
    ...
    def test_validate_parameters_all_valid_no_defaults(self):
        ...
        self.assertDictEqual(validate_parameters(parameter_apis, inputs, 'app1', 'action1'), expected)
