...
__execution_tests = [test_argument, test_execution_runtime, test_execution_events, test_execution_modes,
                     ...
                     test_json_element_creator, test_json_element_reader, test_json_playbook_loader,
