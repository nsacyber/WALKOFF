...
class TestTransform(unittest.TestCase):
    ...
    def test_init_with_args(self):
        filter_elem = Transform('HelloWorld', action='mod1_filter2', arguments=[Argument('arg1', value='5.4')])
    ...
    def test_init_with_invalid_arg_name(self):
        with self.assertRaises(InvalidArgument):
            Transform('HelloWorld', action='mod1_filter2', arguments=[Argument('invalid', value='5.4')])

    def test_init_with_invalid_arg_type(self):
        with self.assertRaises(InvalidArgument):
            Transform('HelloWorld', action='mod1_filter2', arguments=[Argument('arg1', value='invalid')])
    ...
    def test_execute_with_args_no_conversion(self):
        self.assertAlmostEqual(
            Transform('HelloWorld', action='mod1_filter2', arguments=[Argument('arg1', value='10.3')]).execute('5.4', {}), 15.7)
    ...
    def test_call_with_args_invalid_input(self):
        self.assertEqual(
            Transform('HelloWorld', action='mod1_filter2', arguments=[Argument('arg1', value='10.3')]).execute('invalid', {}),
            'invalid')
