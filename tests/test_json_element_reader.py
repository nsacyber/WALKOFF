...
class TestJsonElementReader(TestCase):
    ...
    def test_single_primitive_value_not_executionelement(self):
        class Test(object):
            def __init__(self):
                self.a = 42
        test = Test()
    ...
    def test_not_execution_element_with_list_all_primitives(self):
        class Test(object):
            def __init__(self):
                ...
                self.b = ['a', 'True', True]
        test = Test()
        self.assertDictEqual(JsonElementReader.read(test), {'a': 42, 'b': ['a', 'True', True]})
    ...
    def test_execution_element_with_list_all_primitives(self):
        class Test(ExecutionElement):
            def __init__(self):
                ...
                self.b = [True, 'b', 17]
        test = Test()
        self.assertDictEqual(JsonElementReader.read(test), {'a': 42, 'b': [True, 'b', 17]})
    ...
    def test_not_execution_element_with_list_all_execution_elements(self):
        ...
        test = Test()
        self.assertDictEqual(JsonElementReader.read(test), {'a': 42, 'b': [{'c': 'a'}, {'c': 'True'}, {'c': True}]})
    ...
    def test_execution_element_with_list_all_execution_elements(self):
        ...
        test = Test()
        self.assertDictEqual(JsonElementReader.read(test), {'a': 42, 'b': [{'c': True}, {'c': 'b'}, {'c': 17}]})
    ...
    def test_not_execution_element_with_list_some_execution_elements(self):
        ...
        test = Test()
        self.assertDictEqual(JsonElementReader.read(test), {'a': 42, 'b': [{'c': 'a'}, 'True', {'c': True}]})
    ...
    def test_execution_element_with_list_some_execution_elements(self):
        class Test(ExecutionElement):
            def __init__(self):
                ...
                self.b = [A(True), 'b', 17]
        test = Test()
        self.assertDictEqual(JsonElementReader.read(test), {'a': 42, 'b': [{'c': True}, 'b', 17]})
    ...
    def test_not_execution_element_with_dict_all_primitives(self):
        ...
        test = Test()
        self.assertDictEqual(JsonElementReader.read(test),
    ...
    def test_execution_element_with_dict_all_primitives(self):
        ...
        test = Test()
        self.assertDictEqual(JsonElementReader.read(test),
                             {'a': 42, 'b': [{'name': True,  'value': 'b'}, {'name': 'd', 'value': 17}]})
    ...
    def test_nested_in_dict(self):
        ...
        test = Test()
        self.assertDictEqual(JsonElementReader.read(test), {'a': 42, 'b': [{'c': {'d': 'b'}},
                                                                           {'c': {'d': 37}},
                                                                           {'c': {'d': 17}}]})
