...
class TestAction(unittest.TestCase):
    ...
    def __compare_init(self, elem, name, action, app, device_id=None, arguments=None, triggers=None,
    ...
    def test_init_app_and_action_name_different_than_method_name(self):
        action = Action(app='HelloWorld', action='Hello World')
    ...
    def test_init_invalid_action(self):
        with self.assertRaises(UnknownAppAction):
            Action(app='HelloWorld', action='invalid')
    ...
    def test_execute_no_args(self):
        action = Action(app='HelloWorld', action='helloWorld')
    ...
    def test_execute_with_args(self):
        action = Action(app='HelloWorld', action='Add Three',
    ...
    def test_execute_with_complex_args(self):
        action = Action(app='HelloWorld', action='Json Sample',
                      arguments=[
    ...
    def test_execute_action_which_raises_exception(self):
        ...
        action = Action(app='HelloWorld', action='Buggy')
        instance = AppInstance.create(app_name='HelloWorld', device_name='device1')
    ...
    def test_execute_global_action(self):
        action = Action(app='HelloWorld', action='global2', arguments=[Argument('arg1', value='something')])
    ...
    def test_execute_event(self):
        action = Action(app='HelloWorld', action='Sample Event', arguments=[Argument('arg1', value=1)])
        instance = AppInstance.create(app_name='HelloWorld', device_name='device1')
    ...
    def test_execute_with_triggers(self):
        ...
        action = Action(app='HelloWorld', action='helloWorld', triggers=triggers)
        instance = AppInstance.create(app_name='HelloWorld', device_name='device1')
