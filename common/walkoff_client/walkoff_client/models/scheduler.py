...
class Scheduler(object):
    ...
    def __init__(self, status=None):  # noqa: E501
        """Scheduler - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this Scheduler.  # noqa: E501

        State of trigger  # noqa: E501

        :return: The status of this Scheduler.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this Scheduler.

        State of trigger  # noqa: E501

        :param status: The status of this Scheduler.  # noqa: E501
        :type: str
        """
        if status is None:
