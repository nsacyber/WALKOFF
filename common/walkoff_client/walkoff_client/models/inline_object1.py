...
class InlineObject1(object):
    ...
    @property
    def status(self):
        """Gets the status of this InlineObject1.  # noqa: E501

        Requested status of the scheduler  # noqa: E501

        :return: The status of this InlineObject1.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this InlineObject1.

        Requested status of the scheduler  # noqa: E501

        :param status: The status of this InlineObject1.  # noqa: E501
        :type: str
        """
        if status is None:
