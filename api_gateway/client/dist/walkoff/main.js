...
var VariableModalComponent = /** @class */ (function () {
    ...
    VariableModalComponent.prototype.addPermission = function () {
        ...
        this.variable.permissions.sort(function (a, b) { return _this.getRoleName(a).localeCompare(_this.getRoleName(b)); });
        this.newPermission = { role: '', permissions: '' };
    };
...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.editUser = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                modalRef = this.modalService.open(_main_profile_modal_component__WEBPACK_IMPORTED_MODULE_12__["MainProfileModalComponent"]);
                modalRef.componentInstance.username = this.currentUser;
                modalRef.result.then(function (user) { return _this.toastrService.success('Updated Profile'); });
...
var MainProfileModalComponent = /** @class */ (function () {
    function MainProfileModalComponent(mainService, activeModal, toastrService) {
        this.mainService = mainService;
        this.activeModal = activeModal;
        this.toastrService = toastrService;
    ...
    MainProfileModalComponent.prototype.submit = function () {
        ...
        this.mainService
            ...
            .then(function (user) { return _this.activeModal.close(user); })
            .catch(function (e) { return _this.toastrService.error(e.error.detail); });
    };
