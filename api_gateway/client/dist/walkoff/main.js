...
/***/ "./node_modules/raw-loader/index.js!./src/app/globals/globals.modal.html":
/*!**********************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/globals/globals.modal.html ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/main/main.profile.modal.html":
/*!************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/main/main.profile.modal.html ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"modal-header\">\n\t<h4 class=\"modal-title\">Edit Profile</h4>\n</div>\n<div id=\"userModalBody\" class=\"modal-body\">\n\t<div class=\"container-fluid\">\n\t\t<form #userForm=\"ngForm\" (ngSubmit)=\"submit()\">\n\t\t<button type=“submit” style=\"display: none;\"></button>\n\t\t\t<div *ngIf=\"user\" class=\"row\">\n\t\t\t\t<div class=\"col\">\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label for=\"username\">\n\t\t\t\t\t\t\tUsername <i class=\"fa fa-asterisk required\" title=\"This field is required.\"></i>\n\t\t\t\t\t\t</label>\n\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" [class.is-invalid]=\"username.touched && username.invalid\" [(ngModel)]=\"editPersonalUser.new_username\" name=\"username\" #username=\"ngModel\" required>\n\t\t\t\t\t\t<div class=\"invalid-feedback\">\n\t\t\t\t\t\t\tUsername is required.\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"form-group\" *ngIf=\"user.id\">\n\t\t\t\t\t\t<label for=\"currentPassword\">Current Password</label>\n\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" [(ngModel)]=\"editPersonalUser.old_password\" #currentPassword=\"ngModel\" name=\"currentPassword\">\n\t\t\t\t\t\t<div *ngIf=\"currentPassword.errors && (currentPassword.dirty || currentPassword.touched)\" class=\"alert alert-danger\">\n\t\t\t\t\t\t\t<div [hidden]=\"!currentPassword.errors.required\">\n\t\t\t\t\t\t\t\tThe user's current password is required.\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label for=\"newPassword\">\n\t\t\t\t\t\t\tNew Password\n\t\t\t\t\t\t\t<i *ngIf=\"!this.user.id\" class=\"fa fa-asterisk required\" title=\"This field is required.\"></i>\n\t\t\t\t\t\t</label>\n\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" [(ngModel)]=\"editPersonalUser.password\" #newPassword=\"ngModel\" name=\"newPassword\">\n\t\t\t\t\t\t<div *ngIf=\"(!user.id || user.currentPassword) && (newPassword.dirty || newPassword.touched) && !newPassword.value\"\n\t\t\t\t\t\t\tclass=\"alert alert-danger\">\n\t\t\t\t\t\t\tPassword is required.\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label for=\"confirmNewPassword\">\n\t\t\t\t\t\t\tConfirm New Password\n\t\t\t\t\t\t\t<i *ngIf=\"!this.user.id\" class=\"fa fa-asterisk required\" title=\"This field is required.\"></i>\n\t\t\t\t\t\t</label>\n\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" [(ngModel)]=\"passwordConfirm\" #confirmNewPassword=\"ngModel\" name=\"confirmNewPassword\">\n\t\t\t\t\t\t<div *ngIf=\"confirmNewPassword.dirty && confirmNewPassword.touched && confirmNewPassword.value && newPassword.value !== confirmNewPassword.value\"\n\t\t\t\t\t\t\tclass=\"alert alert-danger\">\n\t\t\t\t\t\t\tPasswords do not match.\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div *ngIf=\"confirmNewPassword.dirty && confirmNewPassword.touched && !confirmNewPassword.value\" class=\"alert alert-danger\">\n\t\t\t\t\t\t\tYou must re-enter the new password to confirm.\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</form>\n\t</div>\n</div>\n<div class=\"modal-footer\">\n\t<button type=\"button\" class=\"btn btn-secondary\" (click)=\"activeModal.dismiss()\">Cancel</button>\n\t<button type=\"button\" class=\"btn btn-primary\" [disabled]=\"!userForm.form.valid\" (click)=\"submit()\">Save</button>\n</div>"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/messages/messages.html":
/*!******************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/messages/messages.html ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/messages/messages.modal.html":
/*!************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/messages/messages.modal.html ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/metrics/metrics.html":
/*!****************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/metrics/metrics.html ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/playbook/import.modal.html":
/*!**********************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/playbook/import.modal.html ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/playbook/playbook.conditional.expression.html":
/*!*****************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/playbook/playbook.conditional.expression.html ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/playbook/playbook.conditions.html":
/*!*****************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/playbook/playbook.conditions.html ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/playbook/playbook.environment.variable.modal.html":
/*!*********************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/playbook/playbook.environment.variable.modal.html ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"modal-header\">\n    <h4 class=\"modal-title\">{{ existing ? 'Edit' : 'Add' }} Local Variable</h4>\n</div>\n<div class=\"modal-body\">\n    <div class=\"container-fluid\">\n        <div class=\"row\">\n            <div class=\"col-12\">\n                <div class=\"form-group\">\n                    <label for=\"name\">Name</label>\n                    <input name=\"name\" type=\"text\" [(ngModel)]=\"variable.name\" class=\"form-control\">\n                </div>\n            </div>\n            <div class=\"col-12\">\n                <div class=\"form-group\">\n                    <label for=\"value\">Default Value</label>\n                    <json-editor #jsonEditor [options]=\"editorOptionsData\" [data]=\"variable.value\" (change)=\"updateValue($event)\"></json-editor>\n                </div>\n            </div>\n            <div class=\"col-12\">\n                <div class=\"form-group\">\n                    <label for=\"description\">Description (optional)</label>\n                    <textarea name=\"description\" rows=\"2\" [(ngModel)]=\"variable.description\" class=\"form-control\"></textarea>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n<div class=\"modal-footer\">\n    <button type=\"button\" class=\"btn btn-secondary\" (click)=\"activeModal.dismiss()\">Close</button>\n    <button type=\"button\" class=\"btn btn-primary\" (click)=\"activeModal.close(variable)\">Save</button>\n</div>"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/playbook/playbook.html":
/*!******************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/playbook/playbook.html ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/playbook/playbook.transforms.html":
/*!*****************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/playbook/playbook.transforms.html ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/scheduler/scheduler.html":
/*!********************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/scheduler/scheduler.html ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/scheduler/scheduler.modal.html":
/*!**************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/scheduler/scheduler.modal.html ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/settings/settings.html":
/*!******************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/settings/settings.html ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/settings/settings.roles.html":
/*!************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/settings/settings.roles.html ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/settings/settings.roles.modal.html":
/*!******************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/settings/settings.roles.modal.html ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/settings/settings.timeout.modal.html":
/*!********************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/settings/settings.timeout.modal.html ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/settings/settings.user.modal.html":
/*!*****************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/settings/settings.user.modal.html ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* harmony import */ var _models_api_appApi__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/api/appApi */ "./src/app/models/api/appApi.ts");
...
var AppService = /** @class */ (function () {
    function AppService(http, utils) {
        this.http = http;
        this.utils = utils;
    }
    /**
     ...
     */
    AppService.prototype.getApis = function () {
        return this.http.get('api/apps/apis')
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["plainToClass"])(_models_api_appApi__WEBPACK_IMPORTED_MODULE_4__["AppApi"], data); })
            .then(function (appApis) { return appApis.filter(function (a) { return a.name !== 'Builtin'; }); })
    ...
    AppService.prototype.getApi = function (id) {
        return this.getApis().then(function (apis) { return apis.find(function (api) { return api.id == id; }); });
    };
    AppService.prototype.getFile = function (appApi, file_path) {
        return this.http.get("api/umpire/file/" + appApi.name + "/" + appApi.app_version, { params: { file_path: file_path } })
            .toPromise()
            .then(function (data) { return data; });
    };
    AppService.prototype.putFile = function (appApi, file_path, file_data) {
        return this.http.post('api/umpire/file_upload', { app_name: appApi.name, app_version: appApi.app_version, file_path: file_path, file_data: file_data })
            .toPromise();
    };
    AppService.prototype.buildImage = function (appApi) {
        return this.http.post("api/umpire/build/" + appApi.name + "/" + appApi.app_version, { app_name: appApi.name, app_version: appApi.app_version })
            .toPromise()
            .then(function (data) { return data.build_id; });
    };
    AppService.prototype.listFiles = function (appApi) {
        return this.http.get("api/umpire/files/" + appApi.name + "/" + appApi.app_version)
            .toPromise()
            .then(function (files) { return files.concat('').map(function (f) { return 'root/' + f; }); })
            .then(this.createTree);
    };
    AppService.prototype.createTree = function (files) {
        var tree = [];
        var sortTree = function (a, b) {
        ...
        files.map(function (file) {
            ...
            var _loop_1 = function (i) {
                ...
                var curIndex = parent.findIndex(function (n) { return n.title == arr[i]; });
                if (curIndex < 0)
                    curIndex = parent.push(node) - 1;
                if (parent[curIndex].folder)
                    parent = parent[curIndex].children;
...
/***/ "./src/app/apps/apps.list.component.ts":
/*!*********************************************!*\
  !*** ./src/app/apps/apps.list.component.ts ***!
  \*********************************************/
...
/* harmony import */ var _playbook_playbook_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../playbook/playbook.service */ "./src/app/playbook/playbook.service.ts");
...
/* harmony import */ var _globals_globals_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../globals/globals.service */ "./src/app/globals/globals.service.ts");
/* harmony import */ var _settings_settings_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../settings/settings.service */ "./src/app/settings/settings.service.ts");
/* harmony import */ var _app_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./app.service */ "./src/app/apps/app.service.ts");
...
var AppsListComponent = /** @class */ (function () {
    function AppsListComponent(playbookService, authService, appService, toastrService, utils, modalService, router) {
        ...
        this.workflows = [];
        this.filterQuery = new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"]();
    ...
    AppsListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.appService.getApis().then(function (apps) { return _this.apps = apps; });
    };
    /**
     * Closes our SSEs on component destroy.
     */
    AppsListComponent.prototype.ngOnDestroy = function () { };
    AppsListComponent.prototype.manageApp = function (app) {
        this.router.navigateByUrl("/apps/" + app.id);
    };
    AppsListComponent.prototype.buildImage = function (appApi) {
        var _this = this;
        this.appService.buildImage(appApi).then(function () {
            _this.toastrService.success("Building App <b>" + appApi.name + "</b>");
        });
    };
    AppsListComponent.ctorParameters = function () { return [
        { type: _playbook_playbook_service__WEBPACK_IMPORTED_MODULE_8__["PlaybookService"] },
    ...
    AppsListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'apps-list-component',
            template: __webpack_require__(/*! raw-loader!./apps.list.html */ "./node_modules/raw-loader/index.js!./src/app/apps/apps.list.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
            providers: [_auth_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"], _globals_globals_service__WEBPACK_IMPORTED_MODULE_10__["GlobalsService"], _settings_settings_service__WEBPACK_IMPORTED_MODULE_11__["SettingsService"]],
            styles: [__webpack_require__(/*! ./apps.list.scss */ "./src/app/apps/apps.list.scss")]
        })
    ], AppsListComponent);
...
module.exports = "/* @import '/client/node_modules/cytoscape-panzoom/cytoscape.js-panzoom.css';\n@import '/client/node_modules/ng2-dnd/bundles/style.css'; */\n#main.appsMain {\n  padding: 10px 15px 0 15px;\n  position: relative; }\n#main.appsBackdrop:before {\n  content: \"\\f1b3\";\n  font-family: FontAwesome;\n  font-style: normal;\n  font-weight: normal;\n  text-decoration: inherit;\n  position: fixed;\n  font-size: 50rem;\n  color: #38607724;\n  right: 4rem;\n  margin-top: -8rem;\n  z-index: -1; }\n.appsMain .parametersEditor .failure {\n  color: crimson; }\n.instruction-container {\n  height: 500px;\n  width: 100%; }\n.instruction-container > .card {\n    max-width: 50%; }\n.workflow-card {\n  height: 100%;\n  max-height: 300px; }\n.workflow-card .card-body {\n    overflow: hidden; }\n.workflow-card .card-text {\n    min-height: 0;\n    overflow: hidden;\n    text-overflow: ellipsis; }\n#playbookToolbar {\n  background-color: #aecbdc;\n  margin-left: 0;\n  margin-bottom: 5px;\n  border: 1px solid #8b9aa3;\n  border-radius: 5px; }\n#playbookToolbar .btn-default {\n  background-color: #aecbdc;\n  border-color: #aecbdc; }\n#playbookToolbar .btn-default:hover {\n  background-color: #eaf2f6;\n  border-color: #eaf2f6;\n  margin: 0;\n  border-radius: 0; }\n#playbookToolbar .btn-group {\n  border-right: 1px solid #8b9aa3; }\n#playbookToolbar .btn-group > .btn:first-child {\n  margin: 0;\n  padding: 10px; }\n#playbookToolbar .btn-toolbar > .btn, .btn-toolbar > .btn-group, .btn-toolbar > .input-group {\n  margin-left: 0; }\n#playbookToolbar .form-control.workflowNameInput {\n  display: inline-block;\n  width: auto; }\n#currentWorkflowText {\n  margin-top: 10px;\n  font-size: 18px; }\n.consoleRow {\n  padding: 10px; }\n/* Console Row = 200px */\n.appsMain .graphEditorRow, .appsMain .graphEditorColumn {\n  height: calc(100vh - 310px);\n  overflow: auto; }\n.appsMain .panel-heading.playbook-heading {\n  cursor: pointer; }\n.workflow-menu {\n  cursor: pointer;\n  padding: unset;\n  position: absolute;\n  top: 0px;\n  right: 0px; }\n.workflow-menu .workflow-menu-link::after {\n    content: none; }\n#playbookEditorTabs {\n  display: inline-block;\n  vertical-align: top;\n  height: 100%;\n  width: 100%;\n  position: inherit;\n  background: transparent; }\n#cy {\n  /* display: inline-block; */\n  /* vertical-align: top; */\n  width: 100%;\n  height: 100%; }\n/* Need to do this else panzoom appears above modals */\n#cy .cy-panzoom {\n  z-index: 10; }\n#cy-instructions {\n  padding: 20px;\n  font-size: 25px; }\n#cy-json-data {\n  background-color: white;\n  color: black;\n  font-weight: normal;\n  height: 630px;\n  width: 500px;\n  resize: none; }\n.appsMain #accordion .card-heading .card-title:after {\n  /* symbol for \"opening\" panels */\n  font: normal normal normal 14px/1 FontAwesome;\n  font-size: inherit;\n  text-rendering: auto;\n  content: \"\\f078\";\n  /* adjust as needed, taken from bootstrap.css */\n  float: right;\n  /* adjust as needed */\n  color: grey;\n  /* adjust as needed */ }\n.no-transition {\n  -webkit-transition: none !important;\n  transition: none !important; }\n.appsMain #accordion .card-heading.collapsed .card-title:after {\n  /* symbol for \"collapsed\" panels */\n  content: \"\\f054\";\n  /* adjust as needed, taken from bootstrap.css */ }\n.appsMain .card-default > .card-heading {\n  background-color: #eaf2f6;\n  font-weight: bolder; }\n.appsMain .parametersEditor input[type=checkbox].form-control {\n  width: 34px;\n  margin: 0 5px; }\n.appsMain .parametersEditor .form-group.argument {\n  margin-bottom: 5px;\n  padding: 5px; }\n.appsMain .parametersEditor .form-group.argument.odd {\n  background-color: #EEE; }\n.appsMain .parametersEditor .indent {\n  border-left: 3px solid #DDD;\n  border-top: 1px solid #DDD;\n  border-bottom: 1px solid #DDD;\n  padding: 5px 0 5px 15px;\n  margin-top: 5px;\n  margin-bottom: 5px; }\n.appsMain .parametersEditor .addBar {\n  margin-bottom: 10px; }\n.appsMain .parametersEditor .addBar button {\n  margin-top: 25px; }\n.appsMain .parametersEditor .propertyHeader {\n  margin-bottom: 5px; }\n.appsMain .parametersEditor .required {\n  color: crimson;\n  margin-left: 5px; }\n.appsMain ngx-datatable datatable-body datatable-body-row datatable-body-cell .datatable-body-cell-label {\n  white-space: initial; }\n#workflowsModal .workflowPanel a {\n  cursor: pointer; }\n#workflowsModal .card-heading h4 {\n  min-height: 30px; }\n#workflowsModal .importContainer {\n  margin-bottom: 5px; }\n#workflowsModal .importContainer h5 {\n  display: inline-block; }\n#workflowsModal .importPlaybookInput {\n  display: inline-block; }\n#workflowsModal > .modal-dialog {\n  max-width: 600px; }\n#workflowsModal .modal-title,\n#executionResultsModal .modal-title,\n#playbookAndWorkflowActionModal .modal-title {\n  display: inline-block; }\n#executionResultsModal > .modal-dialog {\n  max-width: 95%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/apps/manage.app.component.ts":
/*!**********************************************!*\
  !*** ./src/app/apps/manage.app.component.ts ***!
  \**********************************************/
...
/* harmony import */ var jquery_fancytree__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! jquery.fancytree */ "./node_modules/jquery.fancytree/dist/modules/jquery.fancytree.js");
/* harmony import */ var jquery_fancytree__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(jquery_fancytree__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var jquery_fancytree_dist_modules_jquery_fancytree_edit__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! jquery.fancytree/dist/modules/jquery.fancytree.edit */ "./node_modules/jquery.fancytree/dist/modules/jquery.fancytree.edit.js");
/* harmony import */ var jquery_fancytree_dist_modules_jquery_fancytree_edit__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(jquery_fancytree_dist_modules_jquery_fancytree_edit__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var jquery_fancytree_dist_modules_jquery_fancytree_filter__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! jquery.fancytree/dist/modules/jquery.fancytree.filter */ "./node_modules/jquery.fancytree/dist/modules/jquery.fancytree.filter.js");
/* harmony import */ var jquery_fancytree_dist_modules_jquery_fancytree_filter__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(jquery_fancytree_dist_modules_jquery_fancytree_filter__WEBPACK_IMPORTED_MODULE_16__);
...
var ManageAppComponent = /** @class */ (function () {
    function ManageAppComponent(playbookService, authService, appService, activeRoute, toastrService, utils, modalService, router) {
        this.playbookService = playbookService;
        this.authService = authService;
        this.appService = appService;
    ...
    ManageAppComponent.prototype.ngOnInit = function () {
        ...
        this.activeRoute.params.subscribe(function (params) {
            if (params.appId) {
                _this.appService.getApi(params.appId).then(function (app) {
                    _this.currentApp = app;
                    _this.appService.listFiles(app).then(function (files) {
                        _this.filesLoaded = true;
                        _this.fileTree = Object(jquery_fancytree__WEBPACK_IMPORTED_MODULE_14__["createTree"])('#tree', {
                            extensions: ['edit', 'filter'],
                            source: files,
                            activate: function (event, data) { return (data.node.folder) ? '' : _this.loadFile(data.node.data.path); },
                            renderNode: function (event, data) {
                                ...
                                if (node.folder && !$nodeSpan.data('rendered')) {
                                    ...
                                    newFileLink.click(function () {
                                        _this.createFile(node.data.path);
                                        return false;
                                    });
    ...
    Object.defineProperty(ManageAppComponent.prototype, "fileChanged", {
        get: function () {
    ...
    ManageAppComponent.prototype.canDeactivate = function () {
        return this.checkUnsavedChanges();
    };
    ManageAppComponent.prototype.checkUnsavedChanges = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (!this.fileChanged)
                    return [2 /*return*/, true];
                return [2 /*return*/, this.utils.confirm('Any unsaved changes will be lost. Are you sure?', { alwaysResolve: true })];
            });
        });
    };
    ManageAppComponent.prototype.createFile = function (root) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var path, _a, _b, _c;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.checkUnsavedChanges()];
                    case 1:
                        if (!(_d.sent()))
                            return [2 /*return*/];
                        _a = root;
                        return [4 /*yield*/, this.utils.prompt('Enter name for new file')];
                    case 2:
                        path = _a + (_d.sent());
                        return [4 /*yield*/, this.appService.putFile(this.currentApp, path, '')];
                    case 3:
                        _d.sent();
                        _c = (_b = this.fileTree).reload;
                        return [4 /*yield*/, this.appService.listFiles(this.currentApp)];
    ...
    ManageAppComponent.prototype.selectTreeNode = function (path) {
        var newNode = this.fileTree.findFirst((function (n) { return path.localeCompare(n.data.path) == 0; }));
        this.fileTree.activateKey(newNode.key, { noEvents: true });
    };
    ManageAppComponent.prototype.loadFile = function (path, checkUnsaved) {
        if (checkUnsaved === void 0) { checkUnsaved = true; }
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, filetype;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.checkUnsavedChanges()];
                    case 1:
                        _a = !(_b.sent());
                        _b.label = 2;
                    case 2:
                        if (_a)
                            return [2 /*return*/, this.selectTreeNode(this.currentFile)];
                        filetype = codemirror__WEBPACK_IMPORTED_MODULE_13__["findModeByFileName"](path);
                        this.appService.getFile(this.currentApp, path).then(function (content) {
                            _this.orginalContent = _this.content = content;
                            _this.currentFile = path;
                            _this.options.mode = filetype ? filetype.mode : 'null';
                            setTimeout(function () {
                                _this.editorArea.codeMirror.getDoc().clearHistory();
                                _this.editorArea.codeMirrorGlobal.commands.save = function (instance) {
                                    if (instance == _this.editorArea.codeMirror)
                                        _this.saveFile();
                                };
                            });
                        });
    ...
    ManageAppComponent.prototype.saveFile = function () {
        var _this = this;
        if (!this.fileChanged)
            return;
        this.orginalContent = this.content;
        this.appService.putFile(this.currentApp, this.currentFile, this.content).then(function () {
            _this.toastrService.success("Saved <b>" + _this.currentFile + "</b>");
        });
    };
    ManageAppComponent.prototype.buildImage = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.checkUnsavedChanges()];
                    case 1:
                        ...
                        this.appService.buildImage(this.currentApp).then(function () { });
                        return [2 /*return*/];
                }
            });
        });
    };
    ManageAppComponent.prototype.undo = function () {
        this.editorArea.codeMirror.execCommand('undo');
    };
    ManageAppComponent.prototype.redo = function () {
        this.editorArea.codeMirror.execCommand('redo');
    };
    ManageAppComponent.prototype.manageApp = function (app) {
        this.router.navigateByUrl("/apps/" + app.id);
    };
    ManageAppComponent.ctorParameters = function () { return [
        { type: _playbook_playbook_service__WEBPACK_IMPORTED_MODULE_8__["PlaybookService"] },
        { type: _auth_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"] },
        { type: _app_service__WEBPACK_IMPORTED_MODULE_12__["AppService"] },
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('editorArea', { static: false })
    ], ManageAppComponent.prototype, "editorArea", void 0);
    ManageAppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'manage-app-component',
            template: __webpack_require__(/*! raw-loader!./manage.app.html */ "./node_modules/raw-loader/index.js!./src/app/apps/manage.app.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
            providers: [_auth_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"], _globals_globals_service__WEBPACK_IMPORTED_MODULE_10__["GlobalsService"], _settings_settings_service__WEBPACK_IMPORTED_MODULE_11__["SettingsService"]],
            styles: [__webpack_require__(/*! ./manage.app.scss */ "./src/app/apps/manage.app.scss")]
        })
    ], ManageAppComponent);
...
module.exports = "/* @import '/client/node_modules/cytoscape-panzoom/cytoscape.js-panzoom.css';\n@import '/client/node_modules/ng2-dnd/bundles/style.css'; */\n#main.appsMain {\n  padding: 10px 15px 0 15px;\n  position: relative; }\n.appsMain .parametersEditor .failure {\n  color: crimson; }\n.instruction-container {\n  height: 500px;\n  width: 100%; }\n.instruction-container > .card {\n    max-width: 50%; }\n.workflow-card {\n  height: 100%;\n  max-height: 300px; }\n.workflow-card .card-body {\n    overflow: hidden; }\n.workflow-card .card-text {\n    min-height: 0;\n    overflow: hidden;\n    text-overflow: ellipsis; }\n#playbookToolbar {\n  background-color: #aecbdc;\n  margin-left: 0;\n  margin-bottom: 5px;\n  border: 1px solid #8b9aa3;\n  border-radius: 5px; }\n#playbookToolbar .btn-default {\n  background-color: #aecbdc;\n  border-color: #aecbdc; }\n#playbookToolbar .btn-default:hover {\n  background-color: #eaf2f6;\n  border-color: #eaf2f6;\n  margin: 0;\n  border-radius: 0; }\n#playbookToolbar .btn-group {\n  border-right: 1px solid #8b9aa3; }\n#playbookToolbar .btn-group > .btn:first-child {\n  margin: 0;\n  padding: 10px; }\n#playbookToolbar .btn-toolbar > .btn, .btn-toolbar > .btn-group, .btn-toolbar > .input-group {\n  margin-left: 0; }\n#playbookToolbar .form-control.workflowNameInput {\n  display: inline-block;\n  width: auto; }\n#currentWorkflowText {\n  margin-top: 10px;\n  font-size: 18px; }\n.consoleRow {\n  padding: 10px; }\n/* Console Row = 200px */\n.appsMain .graphEditorRow, .appsMain .graphEditorColumn {\n  height: calc(100vh - 310px);\n  overflow: auto; }\n.appsMain .panel-heading.playbook-heading {\n  cursor: pointer; }\n.workflow-menu {\n  cursor: pointer;\n  padding: unset;\n  position: absolute;\n  top: 0px;\n  right: 0px; }\n.workflow-menu .workflow-menu-link::after {\n    content: none; }\n#playbookEditorTabs {\n  display: inline-block;\n  vertical-align: top;\n  height: 100%;\n  width: 100%;\n  position: inherit;\n  background: transparent; }\n#cy {\n  /* display: inline-block; */\n  /* vertical-align: top; */\n  width: 100%;\n  height: 100%; }\n/* Need to do this else panzoom appears above modals */\n#cy .cy-panzoom {\n  z-index: 10; }\n#cy-instructions {\n  padding: 20px;\n  font-size: 25px; }\n#cy-json-data {\n  background-color: white;\n  color: black;\n  font-weight: normal;\n  height: 630px;\n  width: 500px;\n  resize: none; }\n.appsMain #accordion .card-heading .card-title:after {\n  /* symbol for \"opening\" panels */\n  font: normal normal normal 14px/1 FontAwesome;\n  font-size: inherit;\n  text-rendering: auto;\n  content: \"\\f078\";\n  /* adjust as needed, taken from bootstrap.css */\n  float: right;\n  /* adjust as needed */\n  color: grey;\n  /* adjust as needed */ }\n.no-transition {\n  -webkit-transition: none !important;\n  transition: none !important; }\n.appsMain #accordion .card-heading.collapsed .card-title:after {\n  /* symbol for \"collapsed\" panels */\n  content: \"\\f054\";\n  /* adjust as needed, taken from bootstrap.css */ }\n.appsMain .card-default > .card-heading {\n  background-color: #eaf2f6;\n  font-weight: bolder; }\n.appsMain .parametersEditor input[type=checkbox].form-control {\n  width: 34px;\n  margin: 0 5px; }\n.appsMain .parametersEditor .form-group.argument {\n  margin-bottom: 5px;\n  padding: 5px; }\n.appsMain .parametersEditor .form-group.argument.odd {\n  background-color: #EEE; }\n.appsMain .parametersEditor .indent {\n  border-left: 3px solid #DDD;\n  border-top: 1px solid #DDD;\n  border-bottom: 1px solid #DDD;\n  padding: 5px 0 5px 15px;\n  margin-top: 5px;\n  margin-bottom: 5px; }\n.appsMain .parametersEditor .addBar {\n  margin-bottom: 10px; }\n.appsMain .parametersEditor .addBar button {\n  margin-top: 25px; }\n.appsMain .parametersEditor .propertyHeader {\n  margin-bottom: 5px; }\n.appsMain .parametersEditor .required {\n  color: crimson;\n  margin-left: 5px; }\n.appsMain ngx-datatable datatable-body datatable-body-row datatable-body-cell .datatable-body-cell-label {\n  white-space: initial; }\n#workflowsModal .workflowPanel a {\n  cursor: pointer; }\n#workflowsModal .card-heading h4 {\n  min-height: 30px; }\n#workflowsModal .importContainer {\n  margin-bottom: 5px; }\n#workflowsModal .importContainer h5 {\n  display: inline-block; }\n#workflowsModal .importPlaybookInput {\n  display: inline-block; }\n#workflowsModal > .modal-dialog {\n  max-width: 600px; }\n#workflowsModal .modal-title,\n#executionResultsModal .modal-title,\n#playbookAndWorkflowActionModal .modal-title {\n  display: inline-block; }\n#executionResultsModal > .modal-dialog {\n  max-width: 95%; }\n.CodeMirror {\n  min-height: 725px;\n  border: 1px solid #dee2e6 !important; }\n#tree {\n  position: absolute;\n  width: 100%; }\n.fancytree-container {\n  height: 100%;\n  overflow-y: auto; }\n.fancytree-container:focus {\n    outline: none; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _models_accessToken__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/accessToken */ "./src/app/models/accessToken.ts");
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.getAndDecodeRefreshToken = function () {
        return Object(class_transformer__WEBPACK_IMPORTED_MODULE_4__["plainToClass"])(_models_accessToken__WEBPACK_IMPORTED_MODULE_5__["AccessToken"], this.jwtHelper.decodeToken(this.getRefreshToken()));
    };
    /**
    ...
    AuthService.prototype.getAndDecodeAccessToken = function () {
        return Object(class_transformer__WEBPACK_IMPORTED_MODULE_4__["plainToClass"])(_models_accessToken__WEBPACK_IMPORTED_MODULE_5__["AccessToken"], this.jwtHelper.decodeToken(this.getAccessToken()));
    };
    /**
...
var ExecutionComponent = /** @class */ (function () {
    function ExecutionComponent(executionService, authService, cdr, toastrService, utils, modalService, router) {
        ...
        this.filterQuery = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]();
    }
    /**
        ...
        this.recalculateTableCallback = function (e) {
            if (_this.nodeStatusTable && _this.nodeStatusTable.recalculate) {
                if (Array.isArray(_this.nodeStatusTable.rows))
                    _this.nodeStatusTable.rows = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.nodeStatusTable.rows);
    ...
    ExecutionComponent.ctorParameters = function () { return [
        { type: _execution_service__WEBPACK_IMPORTED_MODULE_8__["ExecutionService"] },
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('nodeStatusContainer', { static: false })
    ], ExecutionComponent.prototype, "nodeStatusContainer", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('nodeStatusTable', { static: false })
    ], ExecutionComponent.prototype, "nodeStatusTable", void 0);
    ExecutionComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'execution-component',
            template: __webpack_require__(/*! raw-loader!./execution.html */ "./node_modules/raw-loader/index.js!./src/app/execution/execution.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
...
module.exports = ".executionMain {\n  padding: 10px 15px; }\n\n.executionMain ngx-datatable datatable-body datatable-body-row datatable-body-cell .datatable-body-cell-label {\n  white-space: initial; }\n\n.nodeStatusModal > .modal-dialog {\n  max-width: 95%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _models_execution_workflowStatus__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/execution/workflowStatus */ "./src/app/models/execution/workflowStatus.ts");
/* harmony import */ var _models_playbook_playbook__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/playbook/playbook */ "./src/app/models/playbook/playbook.ts");
...
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
...
var ExecutionService = /** @class */ (function () {
    ...
    ExecutionService.prototype.addWorkflowToQueue = function (workflow_id, execution_id, variables) {
        ...
        if (variables.length > 0)
            data.workflow_variables = Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["classToPlain"])(variables);
        return this.http.post('api/workflowqueue', data)
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["plainToClass"])(_models_execution_workflowStatus__WEBPACK_IMPORTED_MODULE_5__["WorkflowStatus"], data); })
            .catch(this.utils.handleResponseError);
    };
    /**
    ...
    ExecutionService.prototype.getPlaybooks = function () {
        return this.http.get('api/playbooks')
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["plainToClass"])(_models_playbook_playbook__WEBPACK_IMPORTED_MODULE_6__["Playbook"], data); })
            .catch(this.utils.handleResponseError);
    };
    /**
    ...
    ExecutionService.prototype.getWorkflows = function () {
        return this.http.get('api/workflows')
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["plainToClass"])(_models_playbook_workflow__WEBPACK_IMPORTED_MODULE_7__["Workflow"], data); })
            .catch(this.utils.handleResponseError);
    };
    /**
    ...
    ExecutionService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] },
        { type: _utilities_service__WEBPACK_IMPORTED_MODULE_8__["UtilitiesService"] }
    ]; };
    ExecutionService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        })
    ], ExecutionService);
...
var ExecutionVariableModalComponent = /** @class */ (function () {
    ...
    ExecutionVariableModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ], ExecutionVariableModalComponent.prototype, "workflow", void 0);
    ExecutionVariableModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'execution-variable-modal-component',
            template: __webpack_require__(/*! raw-loader!./execution.variable.modal.html */ "./node_modules/raw-loader/index.js!./src/app/execution/execution.variable.modal.html"),
        })
...
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
/* harmony import */ var _variable_modal_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./variable.modal.component */ "./src/app/globals/variable.modal.component.ts");
/* harmony import */ var _globals_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./globals.service */ "./src/app/globals/globals.service.ts");
...
var GlobalsComponent = /** @class */ (function () {
    ...
    GlobalsComponent.prototype.addGlobal = function () {
        var _this = this;
        var modalRef = this.modalService.open(_variable_modal_component__WEBPACK_IMPORTED_MODULE_5__["VariableModalComponent"]);
    ...
    GlobalsComponent.ctorParameters = function () { return [
        { type: _globals_service__WEBPACK_IMPORTED_MODULE_6__["GlobalsService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"] },
        { type: _utilities_service__WEBPACK_IMPORTED_MODULE_7__["UtilitiesService"] }
    ]; };
    GlobalsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'globals-component',
            template: __webpack_require__(/*! raw-loader!./globals.html */ "./node_modules/raw-loader/index.js!./src/app/globals/globals.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
...
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm5/ng-bootstrap.js");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
/* harmony import */ var _globals_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./globals.service */ "./src/app/globals/globals.service.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
/* harmony import */ var _models_workingGlobal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/workingGlobal */ "./src/app/models/workingGlobal.ts");
...
var GlobalsModalComponent = /** @class */ (function () {
    function GlobalsModalComponent(globalsService, activeModal, toastrService, cdr) {
        ...
        this.toastrService = toastrService;
        this.cdr = cdr;
        this.workingGlobal = new _models_workingGlobal__WEBPACK_IMPORTED_MODULE_6__["WorkingGlobal"]();
        this.appNames = [];
        this.appApis = [];
    ...
    GlobalsModalComponent.ctorParameters = function () { return [
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('typeRef', { static: true })
    ], GlobalsModalComponent.prototype, "typeRef", void 0);
    GlobalsModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'global-modal',
            template: __webpack_require__(/*! raw-loader!./globals.modal.html */ "./node_modules/raw-loader/index.js!./src/app/globals/globals.modal.html"),
            providers: [_globals_service__WEBPACK_IMPORTED_MODULE_4__["GlobalsService"], _utilities_service__WEBPACK_IMPORTED_MODULE_5__["UtilitiesService"]],
            styles: [__webpack_require__(/*! ./globals.scss */ "./src/app/globals/globals.scss")]
        })
...
module.exports = "#main.globalsMain {\n  padding: 10px 15px; }\n\n.globalsMain ngx-datatable datatable-body datatable-body-row datatable-body-cell .datatable-body-cell-label {\n  white-space: initial; }\n\n#globalForm input[type=checkbox].form-control {\n  width: 34px;\n  margin: 0 5px; }\n\n#globalForm .confirmLabel {\n  margin-top: 15px; }\n\n#globalForm .required {\n  color: crimson; }\n\n#globalForm .fa {\n  margin-left: 5px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _models_variable__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../models/variable */ "./src/app/models/variable.ts");
...
var GlobalsService = /** @class */ (function () {
    function GlobalsService(http, utils) {
        ...
        this.http = http;
        this.utils = utils;
        this.globalsChange = new rxjs__WEBPACK_IMPORTED_MODULE_6__["Observable"](function (observer) {
    ...
    GlobalsService.prototype.getGlobals = function (page) {
        ...
        return this.http.get("api/globals?page=" + page)
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["plainToClass"])(_models_variable__WEBPACK_IMPORTED_MODULE_7__["Variable"], data); })
            .catch(this.utils.handleResponseError);
    };
    /**
    ...
    GlobalsService.prototype.addGlobal = function (global) {
        var _this = this;
        return this.http.post('api/globals', Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["classToPlain"])(global))
            .toPromise()
    ...
    GlobalsService.prototype.editGlobal = function (global) {
        var _this = this;
        return this.http.put("api/globals/" + global.id, Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["classToPlain"])(global))
            .toPromise()
            .then(function (data) { return _this.emitChange(data); })
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["plainToClass"])(_models_variable__WEBPACK_IMPORTED_MODULE_7__["Variable"], data); })
            .catch(this.utils.handleResponseError);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm5/ng-bootstrap.js");
/* harmony import */ var _models_variable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/variable */ "./src/app/models/variable.ts");
/* harmony import */ var _settings_settings_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../settings/settings.service */ "./src/app/settings/settings.service.ts");
...
var VariableModalComponent = /** @class */ (function () {
    function VariableModalComponent(activeModal, settingsService, toastrService) {
        this.activeModal = activeModal;
        this.settingsService = settingsService;
        this.toastrService = toastrService;
        this.variable = new _models_variable__WEBPACK_IMPORTED_MODULE_3__["Variable"]();
        this.isGlobal = false;
        this.existing = false;
        this.hasPermissions = true;
        this.permissionOptions = _models_variable__WEBPACK_IMPORTED_MODULE_3__["VariablePermission"].PERMISSIONS;
        this.permissions = [];
    ...
    VariableModalComponent.prototype.updateValue = function ($event) {
        this.variable.value = $event;
    };
    VariableModalComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.settingsService.getRoles().then(function (roles) { return (_this.systemRoles = roles); });
        this.initialValue = this.variable.value;
    };
    VariableModalComponent.prototype.addPermission = function () {
        var _this = this;
        if (!this.getRoleName(this.newPermission) ||
            !this.getPermissionDescription(this.newPermission)) {
            return this.toastrService.error("Select a role and permission");
        }
        var existingPermission = this.variable.permissions.find(function (p) { return p.role == _this.newPermission.role; });
        existingPermission
            ? (existingPermission.permissions = this.newPermission.permissions)
            : this.variable.permissions.push(this.newPermission);
        this.variable.permissions.sort(function (a, b) {
            return _this.getRoleName(a).localeCompare(_this.getRoleName(b));
        });
        this.newPermission = { role: "", permissions: "" };
    };
    VariableModalComponent.prototype.deletePermission = function (p) {
        this.variable.permissions = this.variable.permissions.filter(function (permission) { return permission.role != p.role; });
    };
    VariableModalComponent.prototype.getRoleName = function (p) {
        var role = this.systemRoles.find(function (role) { return role.id == p.role; });
        return role ? role.name : null;
    };
    VariableModalComponent.prototype.getPermissionDescription = function (r) {
        var permission = this.permissionOptions.find(function (o) { return JSON.stringify(o.crud) == JSON.stringify(r.permissions); });
        return permission ? permission.description : null;
    };
    VariableModalComponent.prototype.submit = function () {
        if (this.variable.access_level != 2)
            this.variable.permissions = [];
        this.activeModal.close(this.variable);
    };
    VariableModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _settings_settings_service__WEBPACK_IMPORTED_MODULE_4__["SettingsService"] },
    ...
    ], VariableModalComponent.prototype, "jsonEditor", void 0);
    VariableModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: "variable-modal-component",
            template: __webpack_require__(/*! raw-loader!./variable.modal.html */ "./node_modules/raw-loader/index.js!./src/app/globals/variable.modal.html"),
            styles: [__webpack_require__(/*! ./variable.modal.scss */ "./src/app/globals/variable.modal.scss")]
        })
...
/***/ "./src/app/globals/variable.modal.scss":
/*!*********************************************!*\
  !*** ./src/app/globals/variable.modal.scss ***!
  \*********************************************/
/*! no static exports found */
...
module.exports = ".card-header .card-title:after {\n  /* symbol for \"opening\" panels */\n  font: normal normal normal 14px/1 FontAwesome;\n  font-size: inherit;\n  text-rendering: auto;\n  margin-top: 5px;\n  content: \"\\f078\";\n  /* adjust as needed, taken from bootstrap.css */\n  float: right;\n  /* adjust as needed */\n  color: grey;\n  /* adjust as needed */ }\n\n.card-header.collapsed .card-title:after {\n  /* symbol for \"collapsed\" panels */\n  content: \"\\f054\";\n  /* adjust as needed, taken from bootstrap.css */ }\n\n.card-header {\n  cursor: pointer; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _refresh_token_interceptor__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./refresh-token-interceptor */ "./src/app/refresh-token-interceptor.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var ng_pick_datetime__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ng-pick-datetime */ "./node_modules/ng-pick-datetime/picker.module.js");
/* harmony import */ var ng_pick_datetime__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(ng_pick_datetime__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var ng2_dnd__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ng2-dnd */ "./node_modules/ng2-dnd/ng2-dnd.es5.js");
...
/* harmony import */ var angular_gridster2__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! angular-gridster2 */ "./node_modules/angular-gridster2/fesm5/angular-gridster2.js");
/* harmony import */ var ng2_charts__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ng2-charts */ "./node_modules/ng2-charts/index.js");
/* harmony import */ var ng2_charts__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(ng2_charts__WEBPACK_IMPORTED_MODULE_17__);
/* harmony import */ var ang_jsoneditor__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ang-jsoneditor */ "./node_modules/ang-jsoneditor/fesm5/ang-jsoneditor.js");
/* harmony import */ var _ctrl_ngx_codemirror__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @ctrl/ngx-codemirror */ "./node_modules/@ctrl/ngx-codemirror/fesm5/ctrl-ngx-codemirror.js");
/* harmony import */ var codemirror_mode_meta__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! codemirror/mode/meta */ "./node_modules/codemirror/mode/meta.js");
/* harmony import */ var codemirror_mode_meta__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(codemirror_mode_meta__WEBPACK_IMPORTED_MODULE_20__);
/* harmony import */ var codemirror_mode_shell_shell__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! codemirror/mode/shell/shell */ "./node_modules/codemirror/mode/shell/shell.js");
...
/* harmony import */ var codemirror_mode_python_python__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! codemirror/mode/python/python */ "./node_modules/codemirror/mode/python/python.js");
/* harmony import */ var codemirror_mode_python_python__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(codemirror_mode_python_python__WEBPACK_IMPORTED_MODULE_22__);
/* harmony import */ var codemirror_mode_xml_xml__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! codemirror/mode/xml/xml */ "./node_modules/codemirror/mode/xml/xml.js");
/* harmony import */ var codemirror_mode_xml_xml__WEBPACK_IMPORTED_MODULE_23___default = /*#__PURE__*/__webpack_require__.n(codemirror_mode_xml_xml__WEBPACK_IMPORTED_MODULE_23__);
/* harmony import */ var codemirror_mode_yaml_yaml__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! codemirror/mode/yaml/yaml */ "./node_modules/codemirror/mode/yaml/yaml.js");
/* harmony import */ var codemirror_mode_yaml_yaml__WEBPACK_IMPORTED_MODULE_24___default = /*#__PURE__*/__webpack_require__.n(codemirror_mode_yaml_yaml__WEBPACK_IMPORTED_MODULE_24__);
/* harmony import */ var codemirror_mode_powershell_powershell__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! codemirror/mode/powershell/powershell */ "./node_modules/codemirror/mode/powershell/powershell.js");
/* harmony import */ var codemirror_mode_powershell_powershell__WEBPACK_IMPORTED_MODULE_25___default = /*#__PURE__*/__webpack_require__.n(codemirror_mode_powershell_powershell__WEBPACK_IMPORTED_MODULE_25__);
/* harmony import */ var codemirror_mode_dockerfile_dockerfile__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! codemirror/mode/dockerfile/dockerfile */ "./node_modules/codemirror/mode/dockerfile/dockerfile.js");
/* harmony import */ var codemirror_mode_dockerfile_dockerfile__WEBPACK_IMPORTED_MODULE_26___default = /*#__PURE__*/__webpack_require__.n(codemirror_mode_dockerfile_dockerfile__WEBPACK_IMPORTED_MODULE_26__);
/* harmony import */ var codemirror_addon_display_placeholder__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! codemirror/addon/display/placeholder */ "./node_modules/codemirror/addon/display/placeholder.js");
/* harmony import */ var codemirror_addon_display_placeholder__WEBPACK_IMPORTED_MODULE_27___default = /*#__PURE__*/__webpack_require__.n(codemirror_addon_display_placeholder__WEBPACK_IMPORTED_MODULE_27__);
/* harmony import */ var _routing__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./routing */ "./src/app/routing.ts");
...
/* harmony import */ var _scheduler_scheduler_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./scheduler/scheduler.component */ "./src/app/scheduler/scheduler.component.ts");
/* harmony import */ var _playbook_playbook_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./playbook/playbook.component */ "./src/app/playbook/playbook.component.ts");
/* harmony import */ var _globals_globals_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./globals/globals.component */ "./src/app/globals/globals.component.ts");
/* harmony import */ var _messages_messages_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./messages/messages.component */ "./src/app/messages/messages.component.ts");
/* harmony import */ var _metrics_metrics_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./metrics/metrics.component */ "./src/app/metrics/metrics.component.ts");
...
/* harmony import */ var _reports_reports_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./reports/reports.component */ "./src/app/reports/reports.component.ts");
/* harmony import */ var _execution_execution_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./execution/execution.component */ "./src/app/execution/execution.component.ts");
/* harmony import */ var _apps_apps_list_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./apps/apps.list.component */ "./src/app/apps/apps.list.component.ts");
/* harmony import */ var _scheduler_scheduler_modal_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./scheduler/scheduler.modal.component */ "./src/app/scheduler/scheduler.modal.component.ts");
/* harmony import */ var _globals_globals_modal_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./globals/globals.modal.component */ "./src/app/globals/globals.modal.component.ts");
/* harmony import */ var _globals_variable_modal_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./globals/variable.modal.component */ "./src/app/globals/variable.modal.component.ts");
/* harmony import */ var _settings_settings_user_modal_component__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./settings/settings.user.modal.component */ "./src/app/settings/settings.user.modal.component.ts");
/* harmony import */ var _settings_settings_roles_modal_component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./settings/settings.roles.modal.component */ "./src/app/settings/settings.roles.modal.component.ts");
/* harmony import */ var _settings_settings_timeout_modal_component__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ./settings/settings.timeout.modal.component */ "./src/app/settings/settings.timeout.modal.component.ts");
/* harmony import */ var _execution_execution_variable_modal_component__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ./execution/execution.variable.modal.component */ "./src/app/execution/execution.variable.modal.component.ts");
/* harmony import */ var _playbook_playbook_environment_variable_modal_component__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ./playbook/playbook.environment.variable.modal.component */ "./src/app/playbook/playbook.environment.variable.modal.component.ts");
/* harmony import */ var _main_main_profile_modal_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./main/main.profile.modal.component */ "./src/app/main/main.profile.modal.component.ts");
/* harmony import */ var _playbook_playbook_argument_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./playbook/playbook.argument.component */ "./src/app/playbook/playbook.argument.component.ts");
/* harmony import */ var _playbook_playbook_conditions_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ./playbook/playbook.conditions.component */ "./src/app/playbook/playbook.conditions.component.ts");
/* harmony import */ var _playbook_playbook_transforms_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ./playbook/playbook.transforms.component */ "./src/app/playbook/playbook.transforms.component.ts");
/* harmony import */ var _playbook_playbook_conditional_expression_component__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ./playbook/playbook.conditional.expression.component */ "./src/app/playbook/playbook.conditional.expression.component.ts");
/* harmony import */ var _settings_settings_roles_component__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(/*! ./settings/settings.roles.component */ "./src/app/settings/settings.roles.component.ts");
/* harmony import */ var _messages_messages_modal_component__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(/*! ./messages/messages.modal.component */ "./src/app/messages/messages.modal.component.ts");
/* harmony import */ var _pipes_keys_pipe__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(/*! ./pipes/keys.pipe */ "./src/app/pipes/keys.pipe.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(/*! ./utilities.service */ "./src/app/utilities.service.ts");
/* harmony import */ var _reports_manage_reports_component__WEBPACK_IMPORTED_MODULE_56__ = __webpack_require__(/*! ./reports/manage.reports.component */ "./src/app/reports/manage.reports.component.ts");
/* harmony import */ var _reports_widget_modal_component__WEBPACK_IMPORTED_MODULE_57__ = __webpack_require__(/*! ./reports/widget.modal.component */ "./src/app/reports/widget.modal.component.ts");
/* harmony import */ var _pipes_safeEmbed_pipe__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(/*! ./pipes/safeEmbed.pipe */ "./src/app/pipes/safeEmbed.pipe.ts");
/* harmony import */ var _playbook_workflow_editor_component__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(/*! ./playbook/workflow.editor.component */ "./src/app/playbook/workflow.editor.component.ts");
/* harmony import */ var _playbook_metadata_modal_component__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(/*! ./playbook/metadata.modal.component */ "./src/app/playbook/metadata.modal.component.ts");
/* harmony import */ var _playbook_import_modal_component__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(/*! ./playbook/import.modal.component */ "./src/app/playbook/import.modal.component.ts");
/* harmony import */ var _apps_manage_app_component__WEBPACK_IMPORTED_MODULE_62__ = __webpack_require__(/*! ./apps/manage.app.component */ "./src/app/apps/manage.app.component.ts");
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                ...
                _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_9__["JwtModule"].forRoot({
                    config: {
                        tokenGetter: _refresh_token_interceptor__WEBPACK_IMPORTED_MODULE_10__["jwtTokenGetter"],
                        blacklistedRoutes: ['login', 'api/auth', 'api/auth/logout', 'api/auth/refresh']
                    }
                }),
                _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModule"],
                _routing__WEBPACK_IMPORTED_MODULE_28__["RoutingModule"],
                ...
                ng_pick_datetime__WEBPACK_IMPORTED_MODULE_12__["DateTimePickerModule"],
                ng2_dnd__WEBPACK_IMPORTED_MODULE_13__["DndModule"].forRoot(),
                _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_14__["BrowserAnimationsModule"],
                ngx_toastr__WEBPACK_IMPORTED_MODULE_15__["ToastrModule"].forRoot({ positionClass: 'toast-bottom-right', enableHtml: true, onActivateTick: true }),
                angular_gridster2__WEBPACK_IMPORTED_MODULE_16__["GridsterModule"],
                ng2_charts__WEBPACK_IMPORTED_MODULE_17__["ChartsModule"],
                _ctrl_ngx_codemirror__WEBPACK_IMPORTED_MODULE_19__["CodemirrorModule"],
                ang_jsoneditor__WEBPACK_IMPORTED_MODULE_18__["NgJsonEditorModule"]
            ],
            declarations: [
                //Main component
                _main_main_component__WEBPACK_IMPORTED_MODULE_29__["MainComponent"],
                //Router module components
                _playbook_playbook_component__WEBPACK_IMPORTED_MODULE_31__["PlaybookComponent"],
                _playbook_workflow_editor_component__WEBPACK_IMPORTED_MODULE_59__["WorkflowEditorComponent"],
                _scheduler_scheduler_component__WEBPACK_IMPORTED_MODULE_30__["SchedulerComponent"],
                _globals_globals_component__WEBPACK_IMPORTED_MODULE_32__["GlobalsComponent"],
                _messages_messages_component__WEBPACK_IMPORTED_MODULE_33__["MessagesComponent"],
                _metrics_metrics_component__WEBPACK_IMPORTED_MODULE_34__["MetricsComponent"],
                _settings_settings_component__WEBPACK_IMPORTED_MODULE_35__["SettingsComponent"],
                _reports_reports_component__WEBPACK_IMPORTED_MODULE_36__["ReportsComponent"],
                _execution_execution_component__WEBPACK_IMPORTED_MODULE_37__["ExecutionComponent"],
                _apps_apps_list_component__WEBPACK_IMPORTED_MODULE_38__["AppsListComponent"],
                _apps_manage_app_component__WEBPACK_IMPORTED_MODULE_62__["ManageAppComponent"],
                //Modals
                _scheduler_scheduler_modal_component__WEBPACK_IMPORTED_MODULE_39__["SchedulerModalComponent"],
                _globals_globals_modal_component__WEBPACK_IMPORTED_MODULE_40__["GlobalsModalComponent"],
                _globals_variable_modal_component__WEBPACK_IMPORTED_MODULE_41__["VariableModalComponent"],
                _main_main_profile_modal_component__WEBPACK_IMPORTED_MODULE_47__["MainProfileModalComponent"],
                _settings_settings_user_modal_component__WEBPACK_IMPORTED_MODULE_42__["SettingsUserModalComponent"],
                _settings_settings_roles_modal_component__WEBPACK_IMPORTED_MODULE_43__["SettingsRoleModalComponent"],
                _settings_settings_timeout_modal_component__WEBPACK_IMPORTED_MODULE_44__["SettingsTimeoutModalComponent"],
                _messages_messages_modal_component__WEBPACK_IMPORTED_MODULE_53__["MessagesModalComponent"],
                _playbook_playbook_environment_variable_modal_component__WEBPACK_IMPORTED_MODULE_46__["PlaybookEnvironmentVariableModalComponent"],
                _playbook_metadata_modal_component__WEBPACK_IMPORTED_MODULE_60__["MetadataModalComponent"],
                _playbook_import_modal_component__WEBPACK_IMPORTED_MODULE_61__["ImportModalComponent"],
                _execution_execution_variable_modal_component__WEBPACK_IMPORTED_MODULE_45__["ExecutionVariableModalComponent"],
                // Other subcomponents
                _playbook_playbook_argument_component__WEBPACK_IMPORTED_MODULE_48__["PlaybookArgumentComponent"],
                _playbook_playbook_conditions_component__WEBPACK_IMPORTED_MODULE_49__["PlaybookConditionsComponent"],
                _playbook_playbook_transforms_component__WEBPACK_IMPORTED_MODULE_50__["PlaybookTransformsComponent"],
                _playbook_playbook_conditional_expression_component__WEBPACK_IMPORTED_MODULE_51__["PlaybookConditionalExpressionComponent"],
                _settings_settings_roles_component__WEBPACK_IMPORTED_MODULE_52__["SettingsRolesComponent"],
                // Pipes
                _pipes_keys_pipe__WEBPACK_IMPORTED_MODULE_54__["KeysPipe"],
                _reports_manage_reports_component__WEBPACK_IMPORTED_MODULE_56__["ManageReportsComponent"],
                _pipes_safeEmbed_pipe__WEBPACK_IMPORTED_MODULE_58__["SafeEmbedPipe"],
                _reports_widget_modal_component__WEBPACK_IMPORTED_MODULE_57__["WidgetModalComponent"],
            ],
            providers: [
                _utilities_service__WEBPACK_IMPORTED_MODULE_55__["UtilitiesService"],
                _auth_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"],
                _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_9__["JwtInterceptor"],
                {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HTTP_INTERCEPTORS"],
                    useExisting: _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_9__["JwtInterceptor"],
                    multi: true
                },
                {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HTTP_INTERCEPTORS"],
                    useClass: _refresh_token_interceptor__WEBPACK_IMPORTED_MODULE_10__["RefreshTokenInterceptor"],
                    multi: true
                }
            ],
            entryComponents: [
            ...
            bootstrap: [_main_main_component__WEBPACK_IMPORTED_MODULE_29__["MainComponent"]],
        })
    ], MainModule);
    return MainModule;
}());
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _messages_messages_modal_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../messages/messages.modal.component */ "./src/app/messages/messages.modal.component.ts");
...
/* harmony import */ var _auth_auth_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../auth/auth.service */ "./src/app/auth/auth.service.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
/* harmony import */ var _models_message_messageUpdate__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../models/message/messageUpdate */ "./src/app/models/message/messageUpdate.ts");
/* harmony import */ var _models_message_messageListing__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../models/message/messageListing */ "./src/app/models/message/messageListing.ts");
/* harmony import */ var _reports_report_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../reports/report.service */ "./src/app/reports/report.service.ts");
/* harmony import */ var _main_profile_modal_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./main.profile.modal.component */ "./src/app/main/main.profile.modal.component.ts");
...
var MainComponent = /** @class */ (function () {
    function MainComponent(mainService, authService, modalService, toastrService, utils, reportService) {
        ...
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModalRef"].prototype['c'] = _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModalRef"].prototype.close;
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModalRef"].prototype.close = function (reason) {
            var _this = this;
        ...
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModalRef"].prototype['d'] = _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModalRef"].prototype.dismiss;
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModalRef"].prototype.dismiss = function (reason) {
            var _this = this;
            document.querySelector('.modal-backdrop').classList.remove('show');
            document.querySelector('.modal.show').classList.remove('show');
            setTimeout(function () {
    ...
    MainComponent.prototype.ngOnInit = function () {
        ...
        this.reportService.reportsChange.subscribe(function (reports) { return _this.reports = reports; });
    ...
    MainComponent.prototype.getNotificationsSSE = function () {
        ...
        this.authService.getEventSource('api/streams/messages/notifications')
            ...
            _this.eventSource.addEventListener('created', function (message) {
                var newMessage = Object(class_transformer__WEBPACK_IMPORTED_MODULE_4__["plainToClass"])(_models_message_messageListing__WEBPACK_IMPORTED_MODULE_10__["MessageListing"], JSON.parse(message.data));
            ...
            _this.eventSource.addEventListener('responded', function (message) {
                var update = Object(class_transformer__WEBPACK_IMPORTED_MODULE_4__["plainToClass"])(_models_message_messageUpdate__WEBPACK_IMPORTED_MODULE_9__["MessageUpdate"], JSON.parse(message.data));
    ...
    MainComponent.prototype.openMessage = function (event, messageListing) {
        ...
        this.mainService.getMessage(messageListing.id)
            ...
            _this._recalculateNewMessagesCount();
            _this.messageModalRef = _this.modalService.open(_messages_messages_modal_component__WEBPACK_IMPORTED_MODULE_5__["MessagesModalComponent"]);
    ...
    MainComponent.prototype._handleModalClose = function (modalRef) {
        var _this = this;
        modalRef.result
            .then(function (result) { return null; }, function (error) {
            if (error) {
     ...
     */
    MainComponent.prototype.editUser = function () {
        var _this = this;
        var modalRef = this.modalService.open(_main_profile_modal_component__WEBPACK_IMPORTED_MODULE_12__["MainProfileModalComponent"]);
        modalRef.componentInstance.username = this.currentUser;
        modalRef.result.then(function (username) {
            _this.currentUser = username;
            _this.toastrService.success('Updated Profile');
        }, function () { return null; });
        return false;
    };
    MainComponent.ctorParameters = function () { return [
        ...
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"] },
        { type: _utilities_service__WEBPACK_IMPORTED_MODULE_8__["UtilitiesService"] },
        { type: _reports_report_service__WEBPACK_IMPORTED_MODULE_11__["ReportService"] }
    ]; };
    MainComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'main-component',
            template: __webpack_require__(/*! raw-loader!./main.html */ "./node_modules/raw-loader/index.js!./src/app/main/main.html"),
            providers: [_main_service__WEBPACK_IMPORTED_MODULE_6__["MainService"], _auth_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"], _utilities_service__WEBPACK_IMPORTED_MODULE_8__["UtilitiesService"]],
...
/***/ "./src/app/main/main.profile.modal.component.ts":
/*!******************************************************!*\
  !*** ./src/app/main/main.profile.modal.component.ts ***!
  \******************************************************/
/*! exports provided: MainProfileModalComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MainProfileModalComponent", function() { return MainProfileModalComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm5/ng-bootstrap.js");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
...
var MainProfileModalComponent = /** @class */ (function () {
    function MainProfileModalComponent(mainService, activeModal, toastrService, authService) {
        this.mainService = mainService;
        this.activeModal = activeModal;
        this.toastrService = toastrService;
        this.authService = authService;
        this.editPersonalUser = {
            old_username: '',
            new_username: '',
            old_password: '',
            password: ''
    ...
    MainProfileModalComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.mainService.getUser(this.username)
            .then(function (profile) {
            _this.user = profile;
            _this.editPersonalUser.old_username = profile.username;
            _this.editPersonalUser.new_username = profile.username;
        });
    };
    MainProfileModalComponent.prototype.submit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var validationMessage, profileData, e_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        profileData = Object.assign({}, this.editPersonalUser);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.mainService.updateUser(profileData)];
                    case 2:
                        // Update the user profile
                        _a.sent();
                        if (!(profileData.old_username != profileData.new_username)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.authService.login(profileData.new_username, profileData.password)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
                    ...
                    case 5:
                        e_1 = _a.sent();
                        this.toastrService.error(e_1.error ? e_1.error.detail : 'Current Password is incorrect.');
                        return [3 /*break*/, 6];
    ...
    MainProfileModalComponent.prototype.validate = function () {
        if (!this.editPersonalUser.new_username) {
            return 'Username is not specified.';
        }
        if (!this.editPersonalUser.old_password) {
            return 'You must specify a password.';
        }
        if (this.passwordConfirm !== this.editPersonalUser.password) {
            return 'Passwords do not match.';
        }
        return '';
    };
    MainProfileModalComponent.ctorParameters = function () { return [
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ], MainProfileModalComponent.prototype, "username", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ], MainProfileModalComponent.prototype, "submitText", void 0);
    MainProfileModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'main-profile',
            template: __webpack_require__(/*! raw-loader!./main.profile.modal.html */ "./node_modules/raw-loader/index.js!./src/app/main/main.profile.modal.html"),
            providers: [_main_service__WEBPACK_IMPORTED_MODULE_4__["MainService"], _utilities_service__WEBPACK_IMPORTED_MODULE_5__["UtilitiesService"]],
            styles: [__webpack_require__(/*! ./main.scss */ "./src/app/main/main.scss")]
        })
    ], MainProfileModalComponent);
    return MainProfileModalComponent;
}());
...
module.exports = "/* @import '~@swimlane/ngx-datatable/release/index.css';\n@import '~@swimlane/ngx-datatable/release/themes/material.css';\n@import '~@swimlane/ngx-datatable/release/assets/icons.css';\n@import '~bootstrap/dist/css/bootstrap.min.css';\n@import '~font-awesome/css/font-awesome.min.css';\n@import '~ng2-toasty/style-bootstrap.css';\n@import '~select2/dist/css/select2.min.css'; */\n/* h1 {\n  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif, sans-serif;\n  font-weight: bold;\n  font-size: 30px;\n  color: #255876;\n}\n\nh3 {\n  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif, sans-serif;\n  font-weight: bold;\n} */\n.contentContainer {\n  position: relative;\n  padding-bottom: 56.25%;\n  /* 16:9 */\n  padding-top: 25px;\n  height: 0; }\n/* .contentContainer iframe {\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n} */\n#walkoffNav {\n  background-color: #3c8dbc; }\n/* #walkoffNav a {\n  color: #f6f6f6;\n} */\n#walkoffNav a .navLink {\n  margin-left: 5px; }\n/* #walkoffNav .dropdown-item {\n  color: #333333;\n} */\n#walkoffNav {\n  margin-bottom: 0;\n  border: none;\n  border-radius: 0; }\n#walkoffNav .user-image {\n  float: left;\n  width: 25px;\n  height: 25px;\n  border-radius: 50%;\n  margin-right: 10px;\n  margin-top: -2px; }\n@media (max-width: 767px) {\n  #walkoffNav .user-image {\n    float: none;\n    margin-right: 0;\n    margin-top: -8px;\n    line-height: 10px; } }\n#walkoffNav .navbar-nav .dropdown .dropdown-menu {\n  background-color: #3c8dbc; }\n#walkoffNav .navbar-nav .dropdown .dropdown-menu a {\n  color: rgba(255, 255, 255, 0.5); }\n#walkoffNav .navbar-nav .dropdown .dropdown-menu a:active {\n    color: #3c8dbc;\n    background-color: #f8f9fa; }\n#walkoffNav .navbar-nav .dropdown .dropdown-menu a.active {\n  color: #fff;\n  background-color: unset; }\n#walkoffNav .navbar-nav .dropdown .dropdown-menu a.active:hover {\n    color: #3c8dbc;\n    background-color: #f8f9fa; }\n#walkoffNav .navbar-nav .dropdown .dropdown-menu a:hover {\n  color: #3c8dbc; }\n#walkoffNav .navbar-nav .dropdown .dropdown-menu a span {\n  margin-left: 5px; }\n#walkoffNav .navbar-nav > .open > a {\n  color: #3c8dbc; }\n#walkoffNav .navbar-nav .newMessages {\n  color: orange;\n  font-weight: bold; }\n#walkoffNav .navbar-nav .required {\n  color: crimson; }\n#walkoffNav .navbar-nav .messages-menu table,\n#walkoffNav .navbar-nav .messages-menu table a {\n  width: 320px;\n  color: white;\n  margin: 5px; }\n#walkoffNav .navbar-nav .messages-menu table .oldMessage,\n#walkoffNav .navbar-nav .messages-menu table .oldMessage a {\n  color: #DDD;\n  font-style: italic; }\n#walkoffNav .navbar-nav .messages-menu .noMessages {\n  color: #DDD;\n  font-style: italic;\n  margin-left: 10px; }\n#walkoffNav .navbar-nav .messages-menu table tr {\n  border-bottom: 1px solid #AAA; }\n#walkoffNav .navbar-nav .messages-menu table tr:last-child {\n  border-bottom: none; }\n#userModalBody .required {\n  color: crimson;\n  margin-left: 5px; }\n#userModalBody input[type=checkbox].form-control,\n#userModalBody input[type=radio].form-control {\n  width: 34px;\n  margin: 0 5px; }\n.footer {\n  position: absolute;\n  bottom: 0;\n  width: 100%;\n  height: 51px;\n  background-color: #e7e7e7;\n  padding: 15px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _models_message_message__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/message/message */ "./src/app/models/message/message.ts");
/* harmony import */ var _models_message_messageListing__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/message/messageListing */ "./src/app/models/message/messageListing.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
...
var MainService = /** @class */ (function () {
    ...
    MainService.prototype.getInitialNotifications = function () {
        return this.http.get('api/notifications')
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["plainToClass"])(_models_message_messageListing__WEBPACK_IMPORTED_MODULE_5__["MessageListing"], data); })
            .catch(this.utils.handleResponseError);
    };
    /**
    ...
    MainService.prototype.getMessage = function (messageId) {
        return this.http.get("api/messages/" + messageId)
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["plainToClass"])(_models_message_message__WEBPACK_IMPORTED_MODULE_4__["Message"], data); })
            .catch(this.utils.handleResponseError);
    };
    /**
    ...
    MainService.prototype.updateUser = function (data) {
...
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm5/ng-bootstrap.js");
/* harmony import */ var _messages_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./messages.service */ "./src/app/messages/messages.service.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
/* harmony import */ var _messages_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./messages.modal.component */ "./src/app/messages/messages.modal.component.ts");
...
var MessagesComponent = /** @class */ (function () {
    ...
    MessagesComponent.prototype.openMessage = function (event, messageListing) {
        ...
        this.messagesService.getMessage(messageListing.id)
            ...
            messageListing.is_read = true;
            messageListing.last_read_at = _this.utils.getCurrentIsoString();
            var modalRef = _this.modalService.open(_messages_modal_component__WEBPACK_IMPORTED_MODULE_7__["MessagesModalComponent"]);
    ...
    MessagesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./messages.html */ "./node_modules/raw-loader/index.js!./src/app/messages/messages.html"),
...
var MessagesModalComponent = /** @class */ (function () {
    ...
    MessagesModalComponent.ctorParameters = function () { return [
    ...
    MessagesModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'messages-modal',
            template: __webpack_require__(/*! raw-loader!./messages.modal.html */ "./node_modules/raw-loader/index.js!./src/app/messages/messages.modal.html"),
            providers: [_messages_service__WEBPACK_IMPORTED_MODULE_4__["MessagesService"], _utilities_service__WEBPACK_IMPORTED_MODULE_5__["UtilitiesService"]],
            styles: [__webpack_require__(/*! ./messages.scss */ "./src/app/messages/messages.scss")]
        })
...
module.exports = ".messagesMain {\n  padding: 10px 15px; }\n\n.messagesMain .unread {\n  font-weight: bold; }\n\n.messagesMain .required {\n  color: crimson; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _models_message_message__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/message/message */ "./src/app/models/message/message.ts");
/* harmony import */ var _models_message_messageListing__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/message/messageListing */ "./src/app/models/message/messageListing.ts");
/* harmony import */ var _models_playbook_argument__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/playbook/argument */ "./src/app/models/playbook/argument.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
...
var MessagesService = /** @class */ (function () {
    ...
    MessagesService.prototype.getMessageListings = function (page) {
        ...
        return this.http.get("api/messages?page=" + page)
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["plainToClass"])(_models_message_messageListing__WEBPACK_IMPORTED_MODULE_5__["MessageListing"], data); })
            .catch(this.utils.handleResponseError);
    };
    /**
    ...
    MessagesService.prototype.getMessage = function (messageId) {
        return this.http.get("api/messages/" + messageId)
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["plainToClass"])(_models_message_message__WEBPACK_IMPORTED_MODULE_4__["Message"], data); })
            .catch(this.utils.handleResponseError);
    };
    /**
    ...
    MessagesService.prototype.respondToMessage = function (workflow_execution_id, action) {
        var arg = new _models_playbook_argument__WEBPACK_IMPORTED_MODULE_6__["Argument"]();
        arg.name = 'action';
        arg.value = action;
        var body = {
...
var MetricsComponent = /** @class */ (function () {
    ...
    MetricsComponent.prototype.recalculateTable = function (event) {
        ...
        if (table && table.recalculate) {
            ...
            if (Array.isArray(table.rows))
                table.rows = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](table.rows);
            table.recalculate();
        }
    };
    /**
    ...
    MetricsComponent.ctorParameters = function () { return [
        { type: _metrics_service__WEBPACK_IMPORTED_MODULE_4__["MetricsService"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"] },
        { type: _utilities_service__WEBPACK_IMPORTED_MODULE_5__["UtilitiesService"] },
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('appMetricsTable', { static: true })
    ], MetricsComponent.prototype, "appMetricsTable", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('workflowMetricsTable', { static: true })
    ...
    MetricsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./metrics.html */ "./node_modules/raw-loader/index.js!./src/app/metrics/metrics.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
...
module.exports = "#main.metricsMain {\n  padding: 10px 15px; }\n\n.metricsMain .box-title {\n  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;\n  font-weight: bold; }\n\n.metricsMain .form-control.input-sm {\n  margin-left: 10px; }\n\n.metricsMain ngx-datatable datatable-body datatable-body-row datatable-body-cell .datatable-body-cell-label {\n  white-space: initial; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _models_metric_appMetric__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/metric/appMetric */ "./src/app/models/metric/appMetric.ts");
/* harmony import */ var _models_metric_workflowMetric__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../models/metric/workflowMetric */ "./src/app/models/metric/workflowMetric.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
...
var MetricsService = /** @class */ (function () {
    ...
    MetricsService.prototype.getAppMetrics = function () {
        return this.http.get('api/metrics/apps')
            ...
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_5__["plainToClass"])(_models_metric_appMetric__WEBPACK_IMPORTED_MODULE_6__["AppMetric"], data); })
            .catch(this.utils.handleResponseError);
    };
    /**
    ...
    MetricsService.prototype.getWorkflowMetrics = function () {
        return this.http.get('api/metrics/workflows')
            ...
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_5__["plainToClass"])(_models_metric_workflowMetric__WEBPACK_IMPORTED_MODULE_7__["WorkflowMetric"], data); })
            .catch(this.utils.handleResponseError);
    };
    MetricsService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
        { type: _utilities_service__WEBPACK_IMPORTED_MODULE_8__["UtilitiesService"] }
    ]; };
...
/* harmony import */ var _userClaims__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./userClaims */ "./src/app/models/userClaims.ts");
...
var AccessToken = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _userClaims__WEBPACK_IMPORTED_MODULE_2__["UserClaims"]; })
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _parameterApi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./parameterApi */ "./src/app/models/api/parameterApi.ts");
/* harmony import */ var _returnApi__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./returnApi */ "./src/app/models/api/returnApi.ts");
...
var ActionApi = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _parameterApi__WEBPACK_IMPORTED_MODULE_2__["ParameterApi"]; })
    ], ActionApi.prototype, "parameters", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _returnApi__WEBPACK_IMPORTED_MODULE_3__["ReturnApi"]; })
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _actionApi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./actionApi */ "./src/app/models/api/actionApi.ts");
/* harmony import */ var _conditionApi__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./conditionApi */ "./src/app/models/api/conditionApi.ts");
/* harmony import */ var _transformApi__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./transformApi */ "./src/app/models/api/transformApi.ts");
/* harmony import */ var _deviceApi__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./deviceApi */ "./src/app/models/api/deviceApi.ts");
...
var AppApi = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Expose"])({ name: 'actions' }),
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _actionApi__WEBPACK_IMPORTED_MODULE_2__["ActionApi"]; })
    ], AppApi.prototype, "action_apis", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _conditionApi__WEBPACK_IMPORTED_MODULE_3__["ConditionApi"]; })
    ], AppApi.prototype, "condition_apis", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _transformApi__WEBPACK_IMPORTED_MODULE_4__["TransformApi"]; })
    ], AppApi.prototype, "transform_apis", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _deviceApi__WEBPACK_IMPORTED_MODULE_5__["DeviceApi"]; })
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _deviceFieldApi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./deviceFieldApi */ "./src/app/models/api/deviceFieldApi.ts");
...
var DeviceApi = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _deviceFieldApi__WEBPACK_IMPORTED_MODULE_2__["DeviceFieldApi"]; })
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _parameterSchema__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./parameterSchema */ "./src/app/models/api/parameterSchema.ts");
...
var DeviceFieldApi = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _parameterSchema__WEBPACK_IMPORTED_MODULE_2__["ParameterSchema"]; })
...
var NodeStatus = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Exclude"])({ toPlainOnly: true })
...
var NodeStatusEvent = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Expose"])({ name: 'node_id' })
...
/* harmony import */ var _nodeStatusSummary__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./nodeStatusSummary */ "./src/app/models/execution/nodeStatusSummary.ts");
...
var WorkflowStatus = /** @class */ (function () {
    ...
    Object.defineProperty(WorkflowStatus.prototype, "completed_at_local", {
        get: function () {
            if (this.completed_at)
                return moment__WEBPACK_IMPORTED_MODULE_3__(this.completed_at).format('LL LTS');
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(WorkflowStatus.prototype, "completed_at_relative", {
        get: function () {
            if (this.completed_at)
                return moment__WEBPACK_IMPORTED_MODULE_3__(this.completed_at).toNow();
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(WorkflowStatus.prototype, "started_at_local", {
        get: function () {
            if (this.started_at)
                return moment__WEBPACK_IMPORTED_MODULE_3__(this.started_at).format('LL LTS');
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(WorkflowStatus.prototype, "started_at_relative", {
        get: function () {
            if (this.started_at)
                return moment__WEBPACK_IMPORTED_MODULE_3__(this.started_at).toNow();
        },
        enumerable: true,
        configurable: true
    });
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _nodeStatusSummary__WEBPACK_IMPORTED_MODULE_4__["NodeStatusSummary"]; })
    ], WorkflowStatus.prototype, "node_status", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _nodeStatus__WEBPACK_IMPORTED_MODULE_2__["NodeStatus"]; })
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _workflowStatus__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./workflowStatus */ "./src/app/models/execution/workflowStatus.ts");
...
var WorkflowStatusEvent = /** @class */ (function () {
    ...
    WorkflowStatusEvent.prototype.toNewWorkflowStatus = function () {
        var out = new _workflowStatus__WEBPACK_IMPORTED_MODULE_2__["WorkflowStatus"]();
        out.execution_id = this.execution_id;
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _nodeStatusSummary__WEBPACK_IMPORTED_MODULE_3__["NodeStatusSummary"]; })
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _messageBody__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./messageBody */ "./src/app/models/message/messageBody.ts");
...
var Message = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _messageBody__WEBPACK_IMPORTED_MODULE_2__["MessageBody"]; })
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _metric__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./metric */ "./src/app/models/metric/metric.ts");



var ActionMetric = /** @class */ (function () {
    function ActionMetric() {
        this.success_metrics = new _metric__WEBPACK_IMPORTED_MODULE_2__["Metric"]();
        this.error_metrics = new _metric__WEBPACK_IMPORTED_MODULE_2__["Metric"]();
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _metric__WEBPACK_IMPORTED_MODULE_2__["Metric"]; })
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _actionMetric__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./actionMetric */ "./src/app/models/metric/actionMetric.ts");
...
var AppMetric = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _actionMetric__WEBPACK_IMPORTED_MODULE_2__["ActionMetric"]; })
...
var WorkflowMetric = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](WorkflowMetric, _super);
    function WorkflowMetric() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return WorkflowMetric;
}(_metric__WEBPACK_IMPORTED_MODULE_1__["Metric"]));
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _argument__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./argument */ "./src/app/models/playbook/argument.ts");
...
/* harmony import */ var _executionElement__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./executionElement */ "./src/app/models/playbook/executionElement.ts");
/* harmony import */ var _api_actionApi__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../api/actionApi */ "./src/app/models/api/actionApi.ts");
...
var Action = /** @class */ (function (_super) {
    ...
    function Action() {
        ...
        _this.action_type = _api_actionApi__WEBPACK_IMPORTED_MODULE_5__["ActionType"].ACTION;
        _this.arguments = [];
        return _this;
    }
    Object.defineProperty(Action.prototype, "all_errors", {
        get: function () {
            var _a;
            return (_a = this.errors).concat.apply(_a, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"]((this.arguments) ? this.arguments.map(function (argument) { return argument.all_errors; }) : []));
        },
        enumerable: true,
        configurable: true
    });
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Expose"])({ name: 'label' })
    ], Action.prototype, "name", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _graphPosition__WEBPACK_IMPORTED_MODULE_3__["GraphPosition"]; })
    ], Action.prototype, "position", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Expose"])({ name: 'name' })
    ], Action.prototype, "action_name", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Expose"])({ name: 'parameters' }),
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _argument__WEBPACK_IMPORTED_MODULE_2__["Argument"]; })
    ...
    return Action;
}(_executionElement__WEBPACK_IMPORTED_MODULE_4__["ExecutionElement"]));
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var class_transformer_TransformOperationExecutor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! class-transformer/TransformOperationExecutor */ "./node_modules/class-transformer/TransformOperationExecutor.js");
/* harmony import */ var class_transformer_TransformOperationExecutor__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(class_transformer_TransformOperationExecutor__WEBPACK_IMPORTED_MODULE_2__);
...
var Argument = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Transform"])(function (value, obj, type) {
            switch (type) {
                case class_transformer_TransformOperationExecutor__WEBPACK_IMPORTED_MODULE_2__["TransformationType"].CLASS_TO_PLAIN:
                    if (value)
                        return value.split('.').map(function (v, i) { return ({ name: 'selection_' + i, value: v }); });
                    break;
                case class_transformer_TransformOperationExecutor__WEBPACK_IMPORTED_MODULE_2__["TransformationType"].PLAIN_TO_CLASS:
...
/* harmony import */ var _graphPosition__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./graphPosition */ "./src/app/models/playbook/graphPosition.ts");
/* harmony import */ var _api_actionApi__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../api/actionApi */ "./src/app/models/api/actionApi.ts");
...
var Condition = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](Condition, _super);
    function Condition() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.action_type = _api_actionApi__WEBPACK_IMPORTED_MODULE_5__["ActionType"].CONDITION;
        _this.name = 'Label';
    ...
    Object.defineProperty(Condition.prototype, "all_errors", {
        get: function () {
            var _a;
            return (_a = this.errors).concat.apply(_a, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.arguments.map(function (argument) { return argument.all_errors; })));
        },
        enumerable: true,
        configurable: true
    });
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _graphPosition__WEBPACK_IMPORTED_MODULE_4__["GraphPosition"]; })
...
/* harmony import */ var _condition__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./condition */ "./src/app/models/playbook/condition.ts");




var ConditionalExpression = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ConditionalExpression, _super);
    ...
    Object.defineProperty(ConditionalExpression.prototype, "all_errors", {
        get: function () {
            var _a, _b;
            return (_a = (_b = this.errors).concat.apply(_b, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.conditions.map(function (condition) { return condition.all_errors; })))).concat.apply(_a, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.child_expressions.map(function (expression) { return expression.all_errors; })));
        },
        enumerable: true,
        configurable: true
    });
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _condition__WEBPACK_IMPORTED_MODULE_3__["Condition"]; })
    ], ConditionalExpression.prototype, "conditions", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return ConditionalExpression; })
...
var EnvironmentVariable = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["Expose"])({ name: "id_" })
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _workflow__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./workflow */ "./src/app/models/playbook/workflow.ts");
/* harmony import */ var _executionElement__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./executionElement */ "./src/app/models/playbook/executionElement.ts");
...
var Playbook = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](Playbook, _super);
    function Playbook() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.workflows = [];
        return _this;
    ...
    Object.defineProperty(Playbook.prototype, "all_errors", {
        get: function () {
            var _a;
            return (_a = this.errors).concat.apply(_a, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.workflows.map(function (workflow) { return workflow.all_errors; })));
        },
        enumerable: true,
        configurable: true
    });
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _workflow__WEBPACK_IMPORTED_MODULE_2__["Workflow"]; })
...
var Transform = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](Transform, _super);
    function Transform() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.action_type = _api_actionApi__WEBPACK_IMPORTED_MODULE_5__["ActionType"].TRANSFORM;
        _this.name = 'Label';
        _this.app_name = 'Builtin';
...
var Trigger = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](Trigger, _super);
    function Trigger() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.action_type = _api_actionApi__WEBPACK_IMPORTED_MODULE_5__["ActionType"].TRIGGER;
        _this.name = 'Label';
        _this.app_name = 'Builtin';
...
/*!*********************************************!*\
  !*** ./src/app/models/playbook/workflow.ts ***!
  \*********************************************/
/*! exports provided: WorkflowPermission, Workflow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkflowPermission", function() { return WorkflowPermission; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Workflow", function() { return Workflow; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _action__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./action */ "./src/app/models/playbook/action.ts");
/* harmony import */ var _branch__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./branch */ "./src/app/models/playbook/branch.ts");
/* harmony import */ var _executionElement__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./executionElement */ "./src/app/models/playbook/executionElement.ts");
/* harmony import */ var _environmentVariable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./environmentVariable */ "./src/app/models/playbook/environmentVariable.ts");
/* harmony import */ var _condition__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./condition */ "./src/app/models/playbook/condition.ts");
/* harmony import */ var _trigger__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./trigger */ "./src/app/models/playbook/trigger.ts");
/* harmony import */ var _transform__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./transform */ "./src/app/models/playbook/transform.ts");
...
(function (PermissionEnum) {
    ...
    PermissionEnum[PermissionEnum["CAN_SEE"] = 1] = "CAN_SEE";
    PermissionEnum[PermissionEnum["CAN_USE"] = 2] = "CAN_USE";
    PermissionEnum[PermissionEnum["CAN_EDIT"] = 3] = "CAN_EDIT";
})(PermissionEnum || (PermissionEnum = {}));
var WorkflowPermission = /** @class */ (function () {
    // private to disallow creating other instances of this type
    function WorkflowPermission(key, description, crud) {
        this.key = key;
        this.description = description;
        this.crud = crud;
    }
    WorkflowPermission.NONE = new WorkflowPermission(PermissionEnum.NONE, 'No Permission', []);
    WorkflowPermission.CAN_SEE = new WorkflowPermission(PermissionEnum.CAN_SEE, 'Can view', ['read']);
    WorkflowPermission.CAN_USE = new WorkflowPermission(PermissionEnum.CAN_USE, 'Can execute', ['read', 'execute']);
    WorkflowPermission.CAN_EDIT = new WorkflowPermission(PermissionEnum.CAN_EDIT, 'Can modify', ['read', 'update', 'delete', 'execute']);
    WorkflowPermission.PERMISSIONS = [WorkflowPermission.NONE, WorkflowPermission.CAN_SEE, WorkflowPermission.CAN_USE, WorkflowPermission.CAN_EDIT];
    WorkflowPermission.ctorParameters = function () { return [
        { type: undefined },
        { type: undefined },
        { type: Array }
    ]; };
...
var Workflow = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](Workflow, _super);
    function Workflow() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        /**
    ...
    Object.defineProperty(Workflow.prototype, "all_errors", {
        ...
        get: function () {
            var _a;
            return (_a = this.errors).concat.apply(_a, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.nodes.map(function (action) { return action.all_errors; })));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Workflow.prototype.addNode = function (node) {
        if (node instanceof _action__WEBPACK_IMPORTED_MODULE_2__["Action"])
            this.actions.push(node);
        else if (node instanceof _condition__WEBPACK_IMPORTED_MODULE_6__["Condition"])
            this.conditions.push(node);
        else if (node instanceof _trigger__WEBPACK_IMPORTED_MODULE_7__["Trigger"])
            this.triggers.push(node);
        else if (node instanceof _transform__WEBPACK_IMPORTED_MODULE_8__["Transform"])
    ...
    Workflow.prototype.addBranch = function (branch) {
        this.branches.push(branch);
    };
    Workflow.prototype.removeBranch = function (branchId) {
        this.branches = this.branches.filter(function (b) { return b.id !== branchId; });
    };
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _action__WEBPACK_IMPORTED_MODULE_2__["Action"]; })
    ], Workflow.prototype, "actions", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _branch__WEBPACK_IMPORTED_MODULE_3__["Branch"]; })
    ], Workflow.prototype, "branches", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _condition__WEBPACK_IMPORTED_MODULE_6__["Condition"]; })
    ], Workflow.prototype, "conditions", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _trigger__WEBPACK_IMPORTED_MODULE_7__["Trigger"]; })
    ], Workflow.prototype, "triggers", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _transform__WEBPACK_IMPORTED_MODULE_8__["Transform"]; })
    ], Workflow.prototype, "transforms", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _environmentVariable__WEBPACK_IMPORTED_MODULE_5__["EnvironmentVariable"]; }),
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Expose"])({ name: 'workflow_variables' })
...
/***/ "./src/app/models/report/report.ts":
/*!*****************************************!*\
  !*** ./src/app/models/report/report.ts ***!
  \*****************************************/
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _reportWidget__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reportWidget */ "./src/app/models/report/reportWidget.ts");
...
var Report = /** @class */ (function () {
    function Report() {
        this.widgets = [];
        this.id = angular2_uuid__WEBPACK_IMPORTED_MODULE_3__["UUID"].UUID();
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Expose"])({ name: "id_" })
    ], Report.prototype, "id", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _reportWidget__WEBPACK_IMPORTED_MODULE_2__["ReportWidget"]; }, {
            keepDiscriminatorProperty: true,
            discriminator: {
                property: "type_",
                subTypes: [
                    { value: _reportWidget__WEBPACK_IMPORTED_MODULE_2__["BarChartWidget"], name: "bar" },
                    { value: _reportWidget__WEBPACK_IMPORTED_MODULE_2__["PieChartWidget"], name: "pie" },
                    { value: _reportWidget__WEBPACK_IMPORTED_MODULE_2__["LineChartWidget"], name: "line" },
                    { value: _reportWidget__WEBPACK_IMPORTED_MODULE_2__["TextWidget"], name: "text" },
                    { value: _reportWidget__WEBPACK_IMPORTED_MODULE_2__["TableWidget"], name: "table" },
                    { value: _reportWidget__WEBPACK_IMPORTED_MODULE_2__["KibanaWidget"], name: "kibana" },
                ]
            }
        })
    ], Report.prototype, "widgets", void 0);
    return Report;
}());
...
/***/ "./src/app/models/report/reportWidget.ts":
/*!***********************************************!*\
  !*** ./src/app/models/report/reportWidget.ts ***!
  \***********************************************/
/*! exports provided: ReportWidget, ChartWidget, BarChartWidget, PieChartWidget, LineChartWidget, TableWidget, TextWidget, KibanaWidget */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReportWidget", function() { return ReportWidget; });
...
var ReportWidget = /** @class */ (function () {
    function ReportWidget(x, y, cols, rows) {
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
    ...
    Object.defineProperty(ReportWidget.prototype, "type", {
        get: function () {
            return this.type_;
        },
        enumerable: true,
    ...
    ReportWidget.prototype.setMetadata = function (results) {
        this.metadata = results;
    };
    ReportWidget.ctorParameters = function () { return [
        null,
        null,
        null,
        null
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Expose"])({ name: "id_" })
    ], ReportWidget.prototype, "id", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Exclude"])()
    ], ReportWidget.prototype, "metadata", void 0);
    return ReportWidget;
}());

var ChartWidget = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ChartWidget, _super);
...
var BarChartWidget = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](BarChartWidget, _super);
...
var PieChartWidget = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](PieChartWidget, _super);
...
var LineChartWidget = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](LineChartWidget, _super);
...
var TableWidget = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](TableWidget, _super);
...
var TextWidget = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](TextWidget, _super);
    function TextWidget() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type_ = 'text';
        return _this;
...
var KibanaWidget = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](KibanaWidget, _super);
...
var Role = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _resource__WEBPACK_IMPORTED_MODULE_2__["Resource"]; })
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _scheduledTaskTrigger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scheduledTaskTrigger */ "./src/app/models/scheduler/scheduledTaskTrigger.ts");
...
var ScheduledTask = /** @class */ (function () {
    function ScheduledTask() {
        this.workflows = [];
        this.task_trigger = new _scheduledTaskTrigger__WEBPACK_IMPORTED_MODULE_2__["ScheduledTaskTrigger"]();
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _scheduledTaskTrigger__WEBPACK_IMPORTED_MODULE_2__["ScheduledTaskTrigger"]; })
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _role__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./role */ "./src/app/models/role.ts");
...
var User = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_1__["Type"])(function () { return _role__WEBPACK_IMPORTED_MODULE_2__["Role"]; })
...
/*!************************************!*\
  !*** ./src/app/models/variable.ts ***!
  \************************************/
/*! exports provided: VariablePermission, Variable */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VariablePermission", function() { return VariablePermission; });
...
var VariablePermission = /** @class */ (function () {
    // private to disallow creating other instances of this type
    function VariablePermission(key, description, crud) {
        this.key = key;
        this.description = description;
        this.crud = crud;
    }
    VariablePermission.NONE = new VariablePermission(PermissionEnum.NONE, 'No Permission', []);
    VariablePermission.CAN_USE = new VariablePermission(PermissionEnum.CAN_USE, 'Can Use', ['execute']);
    VariablePermission.CAN_SEE = new VariablePermission(PermissionEnum.CAN_SEE, 'Can Decrypt', ['read', 'execute']);
    VariablePermission.CAN_EDIT = new VariablePermission(PermissionEnum.CAN_EDIT, 'Can Modify', ['read', 'update', 'delete', 'execute']);
    VariablePermission.PERMISSIONS = [VariablePermission.NONE, VariablePermission.CAN_USE, VariablePermission.CAN_SEE, VariablePermission.CAN_EDIT];
    VariablePermission.ctorParameters = function () { return [
        { type: undefined },
        { type: undefined },
        { type: Array }
    ]; };
...
var Variable = /** @class */ (function () {
    ...
    Variable.prototype.clone = function () {
        return Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["classToClass"])(this, { ignoreDecorators: true });
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["Expose"])({ name: "id_" })
...
var SafeEmbedPipe = /** @class */ (function () {
    ...
    SafeEmbedPipe.ctorParameters = function () { return [
        { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"] }
    ]; };
    SafeEmbedPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({ name: 'safeEmbed' })
    ], SafeEmbedPipe);
...
var ImportModalComponent = /** @class */ (function () {
    ...
    ImportModalComponent.prototype.onImportSelectChange = function (event) {
        this.importFile = (event.srcElement || event.target).files[0];
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('myForm', { static: true })
    ...
    ImportModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./import.modal.html */ "./node_modules/raw-loader/index.js!./src/app/playbook/import.modal.html"),
        })
...
/* harmony import */ var _settings_settings_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../settings/settings.service */ "./src/app/settings/settings.service.ts");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
/* harmony import */ var _playbook_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./playbook.service */ "./src/app/playbook/playbook.service.ts");
...
var MetadataModalComponent = /** @class */ (function () {
    function MetadataModalComponent(activeModal, playbookService, settingsService, toastrService) {
        this.activeModal = activeModal;
        this.playbookService = playbookService;
        this.settingsService = settingsService;
        this.toastrService = toastrService;
        this.workflow = new _models_playbook_workflow__WEBPACK_IMPORTED_MODULE_3__["Workflow"]();
        this.existing = false;
        this.permissionOptions = _models_playbook_workflow__WEBPACK_IMPORTED_MODULE_3__["WorkflowPermission"].PERMISSIONS;
    ...
    MetadataModalComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.settingsService.getRoles().then(function (roles) { return _this.systemRoles = roles; });
        this.playbookService.getWorkflows().then(function (workflows) { return _this.existingWorkflows = workflows; });
    };
    ...
    MetadataModalComponent.prototype.submit = function () {
        ...
        if (this.myForm.valid) {
            if (this.workflow.access_level != 2)
                this.workflow.permissions = [];
            this.activeModal.close(this.workflow);
        }
    };
    MetadataModalComponent.prototype.addPermission = function () {
        var _this = this;
        console.log('what');
        if (!this.getRoleName(this.newPermission) || !this.getPermissionDescription(this.newPermission)) {
            return this.toastrService.error('Select a role and permission');
        }
        var existingPermission = this.workflow.permissions.find(function (p) { return p.role == _this.newPermission.role; });
        (existingPermission) ?
            existingPermission.permissions = this.newPermission.permissions :
            this.workflow.permissions.push(this.newPermission);
        this.workflow.permissions.sort(function (a, b) { return _this.getRoleName(a).localeCompare(_this.getRoleName(b)); });
        this.newPermission = { role: '', permissions: '' };
    };
    MetadataModalComponent.prototype.deletePermission = function (p) {
        this.workflow.permissions = this.workflow.permissions.filter(function (permission) { return permission.role != p.role; });
    };
    MetadataModalComponent.prototype.getRoleName = function (p) {
        var role = this.systemRoles.find(function (role) { return role.id == p.role; });
        return role ? role.name : null;
    };
    MetadataModalComponent.prototype.getPermissionDescription = function (r) {
        var permission = this.permissionOptions.find(function (o) { return JSON.stringify(o.crud) == JSON.stringify(r.permissions); });
        return permission ? permission.description : null;
    };
    Object.defineProperty(MetadataModalComponent.prototype, "currentTags", {
        get: function () {
            var tags = this.workflow.tags || [];
            this.existingWorkflows.forEach(function (w) { return tags = tags.concat(w.tags); });
            return tags.filter(function (v, i, a) { return a.indexOf(v) == i; });
        },
        enumerable: true,
        configurable: true
    });
    MetadataModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _playbook_service__WEBPACK_IMPORTED_MODULE_6__["PlaybookService"] },
        { type: _settings_settings_service__WEBPACK_IMPORTED_MODULE_4__["SettingsService"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('workflowName', { static: true })
    ], MetadataModalComponent.prototype, "workflowNameModel", void 0);
    MetadataModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'metadata-modal-component',
            template: __webpack_require__(/*! raw-loader!./metadata.modal.html */ "./node_modules/raw-loader/index.js!./src/app/playbook/metadata.modal.html"),
            styles: [__webpack_require__(/*! ./metadata.modal.scss */ "./src/app/playbook/metadata.modal.scss")]
        })
...
/***/ "./src/app/playbook/metadata.modal.scss":
/*!**********************************************!*\
  !*** ./src/app/playbook/metadata.modal.scss ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = ".card-header .card-title:after {\n  /* symbol for \"opening\" panels */\n  font: normal normal normal 14px/1 FontAwesome;\n  font-size: inherit;\n  text-rendering: auto;\n  margin-top: 5px;\n  content: \"\\f078\";\n  /* adjust as needed, taken from bootstrap.css */\n  float: right;\n  /* adjust as needed */\n  color: grey;\n  /* adjust as needed */ }\n\n.card-header.collapsed .card-title:after {\n  /* symbol for \"collapsed\" panels */\n  content: \"\\f054\";\n  /* adjust as needed, taken from bootstrap.css */ }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/playbook/argument */ "./src/app/models/playbook/argument.ts");
...
var PlaybookArgumentComponent = /** @class */ (function () {
    ...
    function PlaybookArgumentComponent() {
        this.createVariable = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.valueType = _models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__["Variant"].STATIC_VALUE;
        this.propertyName = '';
    ...
    PlaybookArgumentComponent.prototype.initParameterSchema = function () {
        ...
        if (this.argument.value == null) {
            ...
            try {
                for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.argument.value), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var item = _c.value;
    ...
    PlaybookArgumentComponent.prototype.initTypeSelector = function () {
        this.valueTypes = [
            { id: _models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__["Variant"].STATIC_VALUE, name: 'Static Value' },
            { id: _models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__["Variant"].ACTION_RESULT, name: 'Action Output' },
            { id: _models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__["Variant"].WORKFLOW_VARIABLE, name: 'Local' },
            { id: _models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__["Variant"].GLOBAL, name: 'Global' }
        ];
    ...
    Object.defineProperty(PlaybookArgumentComponent.prototype, "isReference", {
        get: function () {
            return [_models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__["Variant"].STATIC_VALUE, _models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__["Variant"].GLOBAL, _models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__["Variant"].WORKFLOW_VARIABLE].indexOf(this.argument.variant) == -1;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(PlaybookArgumentComponent.prototype, "isStatic", {
        get: function () {
            return this.argument.variant == _models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__["Variant"].STATIC_VALUE;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(PlaybookArgumentComponent.prototype, "isActionSelect", {
        get: function () {
            return this.argument.variant == _models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__["Variant"].ACTION_RESULT;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(PlaybookArgumentComponent.prototype, "isVariableSelect", {
        get: function () {
            return this.argument.variant == _models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__["Variant"].WORKFLOW_VARIABLE;
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(PlaybookArgumentComponent.prototype, "isGlobalSelect", {
        get: function () {
            return this.argument.variant == _models_playbook_argument__WEBPACK_IMPORTED_MODULE_2__["Variant"].GLOBAL;
        },
        enumerable: true,
        configurable: true
    });
    ...
    PlaybookArgumentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'playbook-argument-component',
            template: __webpack_require__(/*! raw-loader!./playbook.argument.html */ "./node_modules/raw-loader/index.js!./src/app/playbook/playbook.argument.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
            providers: [],
        })
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/index.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_9__);
...
/* harmony import */ var _playbook_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./playbook.service */ "./src/app/playbook/playbook.service.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
/* harmony import */ var _globals_globals_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../globals/globals.service */ "./src/app/globals/globals.service.ts");
/* harmony import */ var _settings_settings_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../settings/settings.service */ "./src/app/settings/settings.service.ts");
/* harmony import */ var _models_playbook_workflow__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../models/playbook/workflow */ "./src/app/models/playbook/workflow.ts");
/* harmony import */ var _models_execution_workflowStatus__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../models/execution/workflowStatus */ "./src/app/models/execution/workflowStatus.ts");
/* harmony import */ var _metadata_modal_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./metadata.modal.component */ "./src/app/playbook/metadata.modal.component.ts");
/* harmony import */ var _import_modal_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./import.modal.component */ "./src/app/playbook/import.modal.component.ts");
/* harmony import */ var _models_execution_workflowStatusEvent__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../models/execution/workflowStatusEvent */ "./src/app/models/execution/workflowStatusEvent.ts");
...
var PlaybookComponent = /** @class */ (function () {
    function PlaybookComponent(playbookService, authService, toastrService, utils, modalService, router) {
        ...
        this.workflowsLoaded = false;
        this.workflows = [];
        this.filterQuery = new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"]();
        this.filteredWorkflows = [];
    }
    /**
     * On component initialization, we grab arrays of globals, app apis, and playbooks/workflows (id, name pairs).
    ...
    PlaybookComponent.prototype.getWorkflowStatusSSE = function (executionId) {
        ...
        return this.authService.getEventSource("api/streams/workflowqueue/workflow_status")
            ...
            Object.values(_models_execution_workflowStatus__WEBPACK_IMPORTED_MODULE_17__["WorkflowStatuses"])
    ...
    PlaybookComponent.prototype.workflowStatusEventHandler = function (message, executionId) {
        var workflowStatusEvent = Object(class_transformer__WEBPACK_IMPORTED_MODULE_9__["plainToClass"])(_models_execution_workflowStatusEvent__WEBPACK_IMPORTED_MODULE_20__["WorkflowStatusEvent"], JSON.parse(message.data));
        if (executionId != workflowStatusEvent.execution_id)
            return;
        switch (workflowStatusEvent.status) {
            case _models_execution_workflowStatus__WEBPACK_IMPORTED_MODULE_17__["WorkflowStatuses"].COMPLETED:
                this.eventSource.close();
                this.toastrService.success("<b>" + workflowStatusEvent.name + "</b> completed");
                break;
            case _models_execution_workflowStatus__WEBPACK_IMPORTED_MODULE_17__["WorkflowStatuses"].ABORTED:
                this.eventSource.close();
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        executionId = angular2_uuid__WEBPACK_IMPORTED_MODULE_5__["UUID"].UUID();
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        blob = _a.sent();
                        Object(file_saver__WEBPACK_IMPORTED_MODULE_4__["saveAs"])(blob, workflow.name + ".json");
                        return [3 /*break*/, 3];
                    case 2:
                        e_2 = _a.sent();
    ...
    PlaybookComponent.prototype.createWorkflow = function () {
        var _this = this;
        var modalRef = this.modalService.open(_metadata_modal_component__WEBPACK_IMPORTED_MODULE_18__["MetadataModalComponent"]);
        modalRef.componentInstance.workflow = new _models_playbook_workflow__WEBPACK_IMPORTED_MODULE_16__["Workflow"]();
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        workflow = _a.sent();
                        modalRef = this.modalService.open(_metadata_modal_component__WEBPACK_IMPORTED_MODULE_18__["MetadataModalComponent"]);
                        modalRef.componentInstance.existing = true;
    ...
    PlaybookComponent.prototype.importWorkflow = function () {
        var _this = this;
        var modalRef = this.modalService.open(_import_modal_component__WEBPACK_IMPORTED_MODULE_19__["ImportModalComponent"]);
    ...
    PlaybookComponent.prototype.filterWorkflows = function () {
        var searchFilter = this.filterQuery.value ? this.filterQuery.value.toLocaleLowerCase() : '';
        var fuse = new fuse_js__WEBPACK_IMPORTED_MODULE_3__(this.workflows, { tokenize: true, matchAllTokens: true, threshold: 0.5, keys: ['name', 'description', 'tags'] });
    ...
    PlaybookComponent.ctorParameters = function () { return [
        { type: _playbook_service__WEBPACK_IMPORTED_MODULE_12__["PlaybookService"] },
        { type: _auth_auth_service__WEBPACK_IMPORTED_MODULE_11__["AuthService"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_7__["ToastrService"] },
        { type: _utilities_service__WEBPACK_IMPORTED_MODULE_13__["UtilitiesService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_10__["NgbModal"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] }
    ]; };
    PlaybookComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'playbook-component',
            template: __webpack_require__(/*! raw-loader!./playbook.html */ "./node_modules/raw-loader/index.js!./src/app/playbook/playbook.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
            providers: [_auth_auth_service__WEBPACK_IMPORTED_MODULE_11__["AuthService"], _globals_globals_service__WEBPACK_IMPORTED_MODULE_14__["GlobalsService"], _settings_settings_service__WEBPACK_IMPORTED_MODULE_15__["SettingsService"]],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _models_playbook_conditionalExpression__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/playbook/conditionalExpression */ "./src/app/models/playbook/conditionalExpression.ts");
...
var PlaybookConditionalExpressionComponent = /** @class */ (function () {
    ...
    PlaybookConditionalExpressionComponent.prototype.addChildExpression = function () {
        this.conditionalExpression.child_expressions.push(new _models_playbook_conditionalExpression__WEBPACK_IMPORTED_MODULE_2__["ConditionalExpression"]());
    };
    /**
    ...
    PlaybookConditionalExpressionComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'playbook-conditional-expression-component',
            template: __webpack_require__(/*! raw-loader!./playbook.conditional.expression.html */ "./node_modules/raw-loader/index.js!./src/app/playbook/playbook.conditional.expression.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
            providers: [],
        })
...
var PlaybookConditionsComponent = /** @class */ (function () {
    ...
    PlaybookConditionsComponent.prototype.getDefaultArgument = function (parameterApi) {
        return Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["plainToClass"])(_models_playbook_argument__WEBPACK_IMPORTED_MODULE_3__["Argument"], {
    ...
    PlaybookConditionsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'playbook-conditions-component',
            template: __webpack_require__(/*! raw-loader!./playbook.conditions.html */ "./node_modules/raw-loader/index.js!./src/app/playbook/playbook.conditions.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
            providers: [],
        })
...
var PlaybookEnvironmentVariableModalComponent = /** @class */ (function () {
    ...
    PlaybookEnvironmentVariableModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    PlaybookEnvironmentVariableModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'playbook-environment-variable-modal-component',
            template: __webpack_require__(/*! raw-loader!./playbook.environment.variable.modal.html */ "./node_modules/raw-loader/index.js!./src/app/playbook/playbook.environment.variable.modal.html"),
        })
...
module.exports = "/* @import '/client/node_modules/cytoscape-panzoom/cytoscape.js-panzoom.css';\n@import '/client/node_modules/ng2-dnd/bundles/style.css'; */\n#main.playbookMain {\n  padding: 10px 15px 0 15px;\n  position: relative; }\n#main.playbookMain:before {\n  content: \"\\f0e8\";\n  font-family: FontAwesome;\n  font-style: normal;\n  font-weight: normal;\n  text-decoration: inherit;\n  position: fixed;\n  font-size: 50rem;\n  color: #38607724;\n  right: 4rem;\n  margin-top: -8rem;\n  z-index: -1; }\n.playbookMain .parametersEditor .failure {\n  color: crimson; }\n.instruction-container {\n  height: 500px;\n  width: 100%; }\n.instruction-container > .card {\n    max-width: 50%; }\n.workflow-card {\n  height: 100%;\n  max-height: 300px; }\n.workflow-card .card-body {\n    overflow: hidden; }\n.workflow-card .card-text {\n    min-height: 0;\n    overflow: hidden;\n    text-overflow: ellipsis; }\n#playbookToolbar {\n  background-color: #aecbdc;\n  margin-left: 0;\n  margin-bottom: 5px;\n  border: 1px solid #8b9aa3;\n  border-radius: 5px; }\n#playbookToolbar .btn-default {\n  background-color: #aecbdc;\n  border-color: #aecbdc; }\n#playbookToolbar .btn-default:hover {\n  background-color: #eaf2f6;\n  border-color: #eaf2f6;\n  margin: 0;\n  border-radius: 0; }\n#playbookToolbar .btn-group {\n  border-right: 1px solid #8b9aa3; }\n#playbookToolbar .btn-group > .btn:first-child {\n  margin: 0;\n  padding: 10px; }\n#playbookToolbar .btn-toolbar > .btn, .btn-toolbar > .btn-group, .btn-toolbar > .input-group {\n  margin-left: 0; }\n#playbookToolbar .form-control.workflowNameInput {\n  display: inline-block;\n  width: auto; }\n#currentWorkflowText {\n  margin-top: 10px;\n  font-size: 18px; }\n.consoleRow {\n  padding: 10px; }\n/* Console Row = 200px */\n.playbookMain .graphEditorRow, .playbookMain .graphEditorColumn {\n  height: calc(100vh - 310px);\n  overflow: auto; }\n.playbookMain .panel-heading.playbook-heading {\n  cursor: pointer; }\n.workflow-menu {\n  cursor: pointer;\n  padding: unset;\n  position: absolute;\n  top: 0px;\n  right: 0px; }\n.workflow-menu .workflow-menu-link::after {\n    content: none; }\n#playbookEditorTabs {\n  display: inline-block;\n  vertical-align: top;\n  height: 100%;\n  width: 100%;\n  position: inherit;\n  background: transparent; }\n#cy {\n  /* display: inline-block; */\n  /* vertical-align: top; */\n  width: 100%;\n  height: 100%; }\n/* Need to do this else panzoom appears above modals */\n#cy .cy-panzoom {\n  z-index: 10; }\n#cy-instructions {\n  padding: 20px;\n  font-size: 25px; }\n#cy-json-data {\n  background-color: white;\n  color: black;\n  font-weight: normal;\n  height: 630px;\n  width: 500px;\n  resize: none; }\n.playbookMain #accordion .card-heading .card-title:after {\n  /* symbol for \"opening\" panels */\n  font: normal normal normal 14px/1 FontAwesome;\n  font-size: inherit;\n  text-rendering: auto;\n  content: \"\\f078\";\n  /* adjust as needed, taken from bootstrap.css */\n  float: right;\n  /* adjust as needed */\n  color: grey;\n  /* adjust as needed */ }\n.no-transition {\n  -webkit-transition: none !important;\n  transition: none !important; }\n.playbookMain #accordion .card-heading.collapsed .card-title:after {\n  /* symbol for \"collapsed\" panels */\n  content: \"\\f054\";\n  /* adjust as needed, taken from bootstrap.css */ }\n.playbookMain .card-default > .card-heading {\n  background-color: #eaf2f6;\n  font-weight: bolder; }\n.playbookMain .parametersEditor input[type=checkbox].form-control {\n  width: 34px;\n  margin: 0 5px; }\n.playbookMain .parametersEditor .form-group.argument {\n  margin-bottom: 5px;\n  padding: 5px; }\n.playbookMain .parametersEditor .form-group.argument.odd {\n  background-color: #EEE; }\n.playbookMain .parametersEditor .indent {\n  border-left: 3px solid #DDD;\n  border-top: 1px solid #DDD;\n  border-bottom: 1px solid #DDD;\n  padding: 5px 0 5px 15px;\n  margin-top: 5px;\n  margin-bottom: 5px; }\n.playbookMain .parametersEditor .addBar {\n  margin-bottom: 10px; }\n.playbookMain .parametersEditor .addBar button {\n  margin-top: 25px; }\n.playbookMain .parametersEditor .propertyHeader {\n  margin-bottom: 5px; }\n.playbookMain .parametersEditor .required {\n  color: crimson;\n  margin-left: 5px; }\n.playbookMain ngx-datatable datatable-body datatable-body-row datatable-body-cell .datatable-body-cell-label {\n  white-space: initial; }\n#workflowsModal .workflowPanel a {\n  cursor: pointer; }\n#workflowsModal .card-heading h4 {\n  min-height: 30px; }\n#workflowsModal .importContainer {\n  margin-bottom: 5px; }\n#workflowsModal .importContainer h5 {\n  display: inline-block; }\n#workflowsModal .importPlaybookInput {\n  display: inline-block; }\n#workflowsModal > .modal-dialog {\n  max-width: 600px; }\n#workflowsModal .modal-title,\n#executionResultsModal .modal-title,\n#playbookAndWorkflowActionModal .modal-title {\n  display: inline-block; }\n#executionResultsModal > .modal-dialog {\n  max-width: 95%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(class_transformer__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _models_playbook_workflow__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/playbook/workflow */ "./src/app/models/playbook/workflow.ts");
...
/* harmony import */ var _models_api_appApi__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/api/appApi */ "./src/app/models/api/appApi.ts");
/* harmony import */ var _globals_globals_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../globals/globals.service */ "./src/app/globals/globals.service.ts");
/* harmony import */ var _execution_execution_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../execution/execution.service */ "./src/app/execution/execution.service.ts");
...
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
/* harmony import */ var angular2_uuid__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! angular2-uuid */ "./node_modules/angular2-uuid/index.js");
/* harmony import */ var angular2_uuid__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(angular2_uuid__WEBPACK_IMPORTED_MODULE_11__);
...
/* harmony import */ var rxjs_add_operator_catch__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! rxjs/add/operator/catch */ "./node_modules/rxjs-compat/_esm5/add/operator/catch.js");
/* harmony import */ var rxjs_add_operator_map__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! rxjs/add/operator/map */ "./node_modules/rxjs-compat/_esm5/add/operator/map.js");
...
var PlaybookService = /** @class */ (function () {
    function PlaybookService(http, utils, executionService, globalsService, settingsService) {
        ...
        this.globalsService = globalsService;
        this.settingsService = settingsService;
        this.workflowsChange = new rxjs_Observable__WEBPACK_IMPORTED_MODULE_12__["Observable"](function (observer) {
            _this.observer = observer;
    ...
    PlaybookService.prototype.newPlaybook = function (playbook) {
        return this.http.post('api/playbooks', Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["classToPlain"])(playbook))
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["plainToClass"])(_models_playbook_playbook__WEBPACK_IMPORTED_MODULE_5__["Playbook"], data); })
            .catch(this.utils.handleResponseError);
    };
    ...
    PlaybookService.prototype.importPlaybook = function (fileToImport) {
        ...
        return this.http.post('api/playbooks', formData, { headers: headers })
            .map(function (res) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["plainToClass"])(_models_playbook_playbook__WEBPACK_IMPORTED_MODULE_5__["Playbook"], res); })
            .catch(function (error) { return rxjs_Observable__WEBPACK_IMPORTED_MODULE_12__["Observable"].throw(error); });
    };
    /**
     * Imports a playbook from a supplied file.
     * @param fileToImport File to be imported
                ...
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, this.http.post('api/workflows', body, { headers: headers })
                                .toPromise()
                                .then(function (data) { return _this.emitChange(data); })
                                .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["plainToClass"])(_models_playbook_workflow__WEBPACK_IMPORTED_MODULE_4__["Workflow"], data); })
                                .catch(this.utils.handleResponseError)];
                }
            });
        });
    ...
    PlaybookService.prototype.newWorkflow = function (workflow) {
        var _this = this;
        workflow.id = angular2_uuid__WEBPACK_IMPORTED_MODULE_11__["UUID"].UUID();
        return this.http.post('api/workflows', Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["classToPlain"])(workflow))
            .toPromise()
            .then(function (data) { return _this.emitChange(data); })
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["plainToClass"])(_models_playbook_workflow__WEBPACK_IMPORTED_MODULE_4__["Workflow"], data); })
            .catch(this.utils.handleResponseError);
    ...
    PlaybookService.prototype.saveWorkflow = function (workflow) {
        var _this = this;
        return this.http.put("api/workflows/" + workflow.id, Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["classToPlain"])(workflow))
            .toPromise()
            .then(function (data) { return _this.emitChange(data); })
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["plainToClass"])(_models_playbook_workflow__WEBPACK_IMPORTED_MODULE_4__["Workflow"], data); })
            .catch(this.utils.handleResponseError);
    ...
    PlaybookService.prototype.getApis = function () {
        return this.http.get('api/apps/apis')
            ...
            // 	}].concat(data);
            // })
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["plainToClass"])(_models_api_appApi__WEBPACK_IMPORTED_MODULE_6__["AppApi"], data); })
            .then(function (appApis) {
            appApis.forEach(function (app) { return app.action_apis.map(function (action) {
                action.app_name = app.name;
                action.app_version = app.app_version;
    ...
    PlaybookService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
        { type: _utilities_service__WEBPACK_IMPORTED_MODULE_10__["UtilitiesService"] },
        { type: _execution_execution_service__WEBPACK_IMPORTED_MODULE_8__["ExecutionService"] },
        { type: _globals_globals_service__WEBPACK_IMPORTED_MODULE_7__["GlobalsService"] },
        { type: _settings_settings_service__WEBPACK_IMPORTED_MODULE_9__["SettingsService"] }
    ]; };
    PlaybookService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        })
    ], PlaybookService);
...
var PlaybookTransformsComponent = /** @class */ (function () {
    ...
    PlaybookTransformsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'playbook-transforms-component',
            template: __webpack_require__(/*! raw-loader!./playbook.transforms.html */ "./node_modules/raw-loader/index.js!./src/app/playbook/playbook.transforms.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
            providers: [],
        })
...
/* harmony import */ var _models_execution_nodeStatusEvent__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../models/execution/nodeStatusEvent */ "./src/app/models/execution/nodeStatusEvent.ts");
/* harmony import */ var _models_execution_consoleLog__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../models/execution/consoleLog */ "./src/app/models/execution/consoleLog.ts");
/* harmony import */ var _playbook_environment_variable_modal_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./playbook.environment.variable.modal.component */ "./src/app/playbook/playbook.environment.variable.modal.component.ts");
/* harmony import */ var _metadata_modal_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./metadata.modal.component */ "./src/app/playbook/metadata.modal.component.ts");
/* harmony import */ var _models_playbook_condition__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ../models/playbook/condition */ "./src/app/models/playbook/condition.ts");
/* harmony import */ var _models_playbook_trigger__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ../models/playbook/trigger */ "./src/app/models/playbook/trigger.ts");
/* harmony import */ var _models_playbook_transform__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ../models/playbook/transform */ "./src/app/models/playbook/transform.ts");
/* harmony import */ var _globals_variable_modal_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ../globals/variable.modal.component */ "./src/app/globals/variable.modal.component.ts");
...
var WorkflowEditorComponent = /** @class */ (function () {
    function WorkflowEditorComponent(playbookService, authService, toastrService, activeRoute, cdr, utils, modalService, router, globalsService) {
        this.playbookService = playbookService;
        this.authService = authService;
        this.toastrService = toastrService;
        this.activeRoute = activeRoute;
     ...
     */
    WorkflowEditorComponent.prototype.initializeCytoscape = function () {
        var _this = this;
        ...
        if (!cyDummy.gridGuide) {
            cytoscape_grid_guide__WEBPACK_IMPORTED_MODULE_13__(cytoscape__WEBPACK_IMPORTED_MODULE_10__, $);
        }
        if (!cyDummy.panzoom) {
 ...
 * Gets a list of all the loaded playbooks along with their workflows.
 */
    WorkflowEditorComponent.prototype.initialLoad = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.globalsService.globalsChange.subscribe(function (globals) { return _this.globals = globals; });
                        return [4 /*yield*/, this.playbookService.getApis().then(function (appApis) { return _this.appApis = appApis.sort(function (a, b) { return a.name > b.name ? 1 : -1; }); })];
                    case 1:
                        _a.sent();
                        this.activeRoute.params.subscribe(function (params) {
 ...
 */
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 4, , 5]);
                        _a = this.selectWorkflow;
                        if (!(workflow.id)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.playbookService.loadWorkflow(workflow.id)];
                    case 1:
                        _b = _c.sent();
                        return [3 /*break*/, 3];
                    case 2:
                    ...
                    case 4:
                        e_1 = _c.sent();
                        this.toastrService.error("Error loading workflow \"" + workflow.name + "\": " + e_1.message);
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/];
                }
            });
    ...
    WorkflowEditorComponent.prototype.selectWorkflow = function (workflow) {
     ...
     */
    WorkflowEditorComponent.prototype.resetSelections = function () {
        this.loadedWorkflow = null;
        this.selectedBranchParams = null;
        this.selectedAction = null;
    };
    WorkflowEditorComponent.prototype.initializeActionArguments = function (workflow) {
        var _this = this;
        workflow.actions.forEach(function (action) {
            var actionApi = _this.getActionApi(action.app_name, action.app_version, action.action_name);
            actionApi.parameters.forEach(function (parameterApi) {
                var argument = action.arguments.find(function (a) { return a.name === parameterApi.name; });
                if (!argument)
                    action.arguments.push(_this.getDefaultArgument(parameterApi));
            });
        });
    };
    ///------------------------------------------------------------------------------------------------------
    ...
    WorkflowEditorComponent.prototype.consoleEventHandler = function (message) {
        ...
        var consoleEvent = Object(class_transformer__WEBPACK_IMPORTED_MODULE_6__["plainToClass"])(_models_execution_consoleLog__WEBPACK_IMPORTED_MODULE_28__["ConsoleLog"], JSON.parse(message.data));
    ...
    WorkflowEditorComponent.prototype.nodeStatusEventHandler = function (message) {
        ...
        var nodeStatusEvent = Object(class_transformer__WEBPACK_IMPORTED_MODULE_6__["plainToClass"])(_models_execution_nodeStatusEvent__WEBPACK_IMPORTED_MODULE_27__["NodeStatusEvent"], JSON.parse(message.data));
    ...
    WorkflowEditorComponent.prototype.statusEventErrorHandler = function (e) {
        ...
        if (this.sseErrorTimeout)
            return;
        this.sseErrorTimeout = setTimeout(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var e_2, options;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    WorkflowEditorComponent.prototype.canDeactivate = function () {
        return this.checkUnsavedChanges();
    };
    WorkflowEditorComponent.prototype.checkUnsavedChanges = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    WorkflowEditorComponent.prototype.setupGraph = function (options) {
        ...
        this.ur.action('add-walkoff-node', function (args) { return _this.insertNodes(args); }, function (args) { return _this.removeNodes(args); });
        this.ur.action('remove-walkoff-node', function (args) { return _this.removeNodes(args); }, function (args) { return _this.insertNodes(args); });
        // Panzoom extension
        this.cy.panzoom({});
        ...
        this.edgeHandler = this.cy.edgehandles({
            ...
            complete: function (sourceNode, targetNodes, addedEntities) {
                ...
                var _loop_1 = function (i) {
                    ...
                    var sourceActionApi = _this.getActionApi(sourceAction.app_name, sourceAction.app_version, sourceAction.action_name);
        ...
        if (!options.zoom || !options.pan)
            setImmediate(function () { return _this.cy.fit(null, 75); });
        ...
        this.cy.on('select unselect', function (e) { return _this.triggerCanvasResize(); });
    ...
    WorkflowEditorComponent.prototype.saveWorkflow = function (cyData) {
        ...
        if (this.loadedWorkflow.id) {
            this.playbookService.saveWorkflow(workflowToSave).then(function (savedWorkflow) {
                _this.selectWorkflow(savedWorkflow);
    ...
    WorkflowEditorComponent.prototype._sanitizeArgumentsForSave = function (action, workflow) {
        ...
        try {
            ...
            for (var idsToRemove_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](idsToRemove), idsToRemove_1_1 = idsToRemove_1.next(); !idsToRemove_1_1.done; idsToRemove_1_1 = idsToRemove_1.next()) {
                var id = idsToRemove_1_1.value;
                args.splice(id, 1);
            }
        }
            ...
            try {
                if (idsToRemove_1_1 && !idsToRemove_1_1.done && (_b = idsToRemove_1.return)) _b.call(idsToRemove_1);
            }
    ...
    WorkflowEditorComponent.prototype.onNodeSelect = function (e) {
        ...
        var actionApi = this.getActionApi(action.app_name, action.app_version, action.action_name);
        var queryPromises = [];
        if (!this.users &&
    ...
    WorkflowEditorComponent.prototype.onNodeRemoved = function (event) {
        var node = event.target, data = node.data();
    ...
    WorkflowEditorComponent.prototype.handleDropEvent = function (e) {
        ...
        var nodes = [this.createWorkflowNode(e.dragData.actionApi, this.createPosition(e.mouseEvent.layerX, e.mouseEvent.layerY))];
        this.ur.do('add-walkoff-node', { nodes: nodes });
    };
    /**
    ...
    WorkflowEditorComponent.prototype.handleDoubleClickEvent = function (actionApi) {
        ...
        var nodes = [this.createWorkflowNode(actionApi, this.getCenterPosition())];
        this.ur.do('add-walkoff-node', { nodes: nodes });
    };
    WorkflowEditorComponent.prototype.createPosition = function (x, y) {
        var pan = this.cy.pan(), zoom = this.cy.zoom();
        return Object(class_transformer__WEBPACK_IMPORTED_MODULE_6__["plainToClass"])(_models_playbook_graphPosition__WEBPACK_IMPORTED_MODULE_24__["GraphPosition"], {
            x: (x - pan.x) / zoom,
            y: (y - pan.y) / zoom,
        });
    };
    WorkflowEditorComponent.prototype.getCenterPosition = function () {
        var extent = this.cy.extent(), avg = function (a, b) { return (a + b) / 2; };
        return Object(class_transformer__WEBPACK_IMPORTED_MODULE_6__["plainToClass"])(_models_playbook_graphPosition__WEBPACK_IMPORTED_MODULE_24__["GraphPosition"], { x: avg(extent.x1, extent.x2), y: avg(extent.y1, extent.y2) });
    };
    /**
     ...
     */
    WorkflowEditorComponent.prototype.insertNodes = function (_a) {
        var _this = this;
        var _b = _a.nodes, nodes = _b === void 0 ? [] : _b, _c = _a.branches, branches = _c === void 0 ? [] : _c;
        nodes.forEach(function (node) {
            _this.loadedWorkflow.addNode(node);
            _this.cy.add({
                group: 'nodes',
                position: _this.utils.cloneDeep(node.position),
                data: {
                    id: node.id,
                    _id: node.id,
                    label: node.name,
                    isStartNode: node.id === _this.loadedWorkflow.start,
                    isParallelized: node instanceof _models_playbook_action__WEBPACK_IMPORTED_MODULE_22__["Action"] && node.parallelized,
        ...
        branches.forEach(function (branch) {
            _this.loadedWorkflow.branches.push(branch);
            _this.cy.add({
                group: 'edges',
                data: {
                    id: branch.id,
    ...
    WorkflowEditorComponent.prototype.removeNodes = function (_a) {
        var _this = this;
        var _b = _a.nodes, nodes = _b === void 0 ? [] : _b, _c = _a.branches, branches = _c === void 0 ? [] : _c;
        nodes.forEach(function (node) {
            _this.loadedWorkflow.branches
                .filter(function (b) { return b.source_id === node.id || b.destination_id === node.id; })
                .filter(function (b) { return !branches.includes(b); })
                .forEach(function (b) { return branches.push(b); });
            _this.cy.elements("[_id=\"" + node.id + "\"]").remove();
        });
        branches.forEach(function (branch) {
            _this.cy.elements("[_id=\"" + branch.id + "\"]").remove();
        });
        return { nodes: nodes, branches: branches };
    };
    WorkflowEditorComponent.prototype.createWorkflowNode = function (actionApi, position, id) {
        var _this = this;
        ...
        switch (actionApi.node_type) {
            case _models_api_actionApi__WEBPACK_IMPORTED_MODULE_21__["ActionType"].CONDITION:
                node = new _models_playbook_condition__WEBPACK_IMPORTED_MODULE_31__["Condition"]();
                break;
            case _models_api_actionApi__WEBPACK_IMPORTED_MODULE_21__["ActionType"].TRIGGER:
                node = new _models_playbook_trigger__WEBPACK_IMPORTED_MODULE_32__["Trigger"]();
                break;
            case _models_api_actionApi__WEBPACK_IMPORTED_MODULE_21__["ActionType"].TRANSFORM:
                node = new _models_playbook_transform__WEBPACK_IMPORTED_MODULE_33__["Transform"]();
                break;
            default:
                node = new _models_playbook_action__WEBPACK_IMPORTED_MODULE_22__["Action"]();
        }
        node.id = id ? id : angular2_uuid__WEBPACK_IMPORTED_MODULE_3__["UUID"].UUID();
    ...
    WorkflowEditorComponent.prototype.removeSelectedNodes = function () {
        var _this = this;
        var selected = this.cy.$(':selected'), nodes = [], branches = [];
        selected.nodes().jsons().forEach(function (i) {
            var node = _this.loadedWorkflow.nodes.find(function (n) { return i.data._id == n.id; });
            if (node)
                nodes.push(node);
        });
        selected.edges().jsons().forEach(function (i) {
            var branch = _this.loadedWorkflow.branches.find(function (b) { return i.data._id == b.id; });
            if (branch)
        ...
        if (selected.length > 0)
            this.ur.do('remove-walkoff-node', { nodes: nodes, branches: branches });
    };
    ///------------------------------------------------------------------------------------------------------
    /// Utility functions
    ///------------------------------------------------------------------------------------------------------
     ...
     */
    WorkflowEditorComponent.prototype.getActionApi = function (appName, appVersion, actionName) {
     ...
     */
    WorkflowEditorComponent.prototype.getActionArgument = function (parameterApi) {
        // Find an existing argument
    ...
    WorkflowEditorComponent.prototype.getInputApiArgs = function (appName, appVersion, actionName, inputName) {
        return this.getActionApi(appName, appVersion, actionName).parameters.find(function (a) { return a.name === inputName; });
    };
    /**
    ...
    Object.defineProperty(WorkflowEditorComponent.prototype, "workflowChanged", {
        get: function () {
    ...
    WorkflowEditorComponent.prototype.switchConsoleTabs = function ($e) {
        var _this = this;
        if ($e.nextId == 'menu-tab')
            return $e.preventDefault();
        this.showConsole = true;
        this.triggerCanvasResize();
        setTimeout(function () { return _this.recalculateConsoleTable($e); }, 255);
    };
    /**
    ...
    WorkflowEditorComponent.prototype.editVariableModal = function (selectedVariable) {
        var _this = this;
        var modalRef = this.modalService.open(_playbook_environment_variable_modal_component__WEBPACK_IMPORTED_MODULE_29__["PlaybookEnvironmentVariableModalComponent"]);
        modalRef.componentInstance.existing = true;
     ...
     * Spawns a modal for adding a new global. Passes in the app names and apis for usage in the modal.
     */
    WorkflowEditorComponent.prototype.addGlobal = function () {
        var _this = this;
        var modalRef = this.modalService.open(_globals_variable_modal_component__WEBPACK_IMPORTED_MODULE_34__["VariableModalComponent"]);
        modalRef.componentInstance.isGlobal = true;
        modalRef.result.then(function (variable) {
            _this.globalsService.addGlobal(variable).then(function () {
                _this.toastrService.success("Added <b>" + variable.name + "</b>");
     ...
     * Spawns a modal for editing an existing global. Passes in the app names and apis for usage in the modal.
     */
    WorkflowEditorComponent.prototype.editGlobal = function (global) {
        var _this = this;
        var modalRef = this.modalService.open(_globals_variable_modal_component__WEBPACK_IMPORTED_MODULE_34__["VariableModalComponent"]);
        modalRef.componentInstance.isGlobal = true;
        modalRef.componentInstance.existing = true;
     ...
     * @param globalToDelete Global to delete
     */
    WorkflowEditorComponent.prototype.deleteGlobal = function (globalToDelete) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    WorkflowEditorComponent.prototype.editDescription = function () {
        var _this = this;
        var modalRef = this.modalService.open(_metadata_modal_component__WEBPACK_IMPORTED_MODULE_30__["MetadataModalComponent"]);
        modalRef.componentInstance.existing = true;
    ...
    WorkflowEditorComponent.prototype.closeActionSettingMenu = function () {
        this.cy.$('this.selectedAction.id').unselect();
        this.triggerCanvasResize();
    };
    WorkflowEditorComponent.prototype.triggerCanvasResize = function () {
        var _this = this;
        // const options = { zoom: this.cy.zoom(), pan: this.cy.pan() }
        // setTimeout(() => this.setupGraph(options), 255);
        var height, width;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["timer"])(0, 50).takeWhile(function (_) { return height != _this.cyRef.nativeElement.offsetHeight || width != _this.cyRef.nativeElement.offsetWidth; })
            .do(function (_) {
            height = _this.cyRef.nativeElement.offsetHeight;
            width = _this.cyRef.nativeElement.offsetWidth;
        })
            .last()
            .subscribe(function (_) { return window.dispatchEvent(new Event('resize')); });
    };
    WorkflowEditorComponent.ctorParameters = function () { return [
        { type: _playbook_service__WEBPACK_IMPORTED_MODULE_16__["PlaybookService"] },
        { type: _auth_auth_service__WEBPACK_IMPORTED_MODULE_17__["AuthService"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_9__["ActivatedRoute"] },
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
        { type: _utilities_service__WEBPACK_IMPORTED_MODULE_18__["UtilitiesService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_7__["NgbModal"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"] },
        { type: _globals_globals_service__WEBPACK_IMPORTED_MODULE_19__["GlobalsService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('cyRef', { static: true })
    ], WorkflowEditorComponent.prototype, "cyRef", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('workflowResultsTable', { static: false })
    ], WorkflowEditorComponent.prototype, "workflowResultsTable", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('consoleContainer', { static: false })
    ], WorkflowEditorComponent.prototype, "consoleContainer", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('consoleTable', { static: false })
    ], WorkflowEditorComponent.prototype, "consoleTable", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('errorLogTable', { static: false })
    ], WorkflowEditorComponent.prototype, "errorLogTable", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('environmentVariableTable', { static: false })
    ], WorkflowEditorComponent.prototype, "environmentVariableTable", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('importFile', { static: false })
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('consoleArea', { static: false })
    ...
    WorkflowEditorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./workflow.editor.html */ "./node_modules/raw-loader/index.js!./src/app/playbook/workflow.editor.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
...
module.exports = "/* @import '/client/node_modules/cytoscape-panzoom/cytoscape.js-panzoom.css';\n@import '/client/node_modules/ng2-dnd/bundles/style.css'; */\n#main.workflowEditorMain {\n  padding: 10px 15px 0 15px; }\n.workflowEditorMain .parametersEditor .failure {\n  color: crimson; }\n#playbookBreadcrumbs.workflow-editor {\n  background-color: unset;\n  -webkit-margin-after: unset;\n          margin-block-end: unset;\n  -webkit-padding-start: unset;\n          padding-inline-start: unset;\n  font-weight: bold;\n  font-size: 1.5rem; }\n#playbookBreadcrumbs.workflow-editor a {\n    text-decoration: none; }\n#playbookToolbar {\n  background-color: #aecbdc;\n  margin-left: 0;\n  margin-bottom: 5px;\n  border: 1px solid #8b9aa3;\n  border-radius: 5px; }\n#playbookToolbar .btn-default {\n  background-color: #aecbdc;\n  border-color: #aecbdc; }\n#playbookToolbar .btn-default:hover {\n  background-color: #eaf2f6;\n  border-color: #eaf2f6;\n  margin: 0;\n  border-radius: 0; }\n#playbookToolbar .btn-group {\n  border-right: 1px solid #8b9aa3; }\n#playbookToolbar .btn-group > .btn:first-child {\n  margin: 0;\n  padding: 10px; }\n#playbookToolbar .btn-toolbar > .btn, .btn-toolbar > .btn-group, .btn-toolbar > .input-group {\n  margin-left: 0; }\n#playbookToolbar .form-control.workflowNameInput {\n  display: inline-block;\n  width: auto; }\n#currentWorkflowText {\n  margin-top: 10px;\n  font-size: 18px; }\n.consoleRow {\n  padding: 10px; }\n/* Console Row = 200px */\n.workflowEditorMain .graphEditorRow {\n  height: calc(100vh - 170px);\n  -webkit-transition: height 0.25s ease-in-out;\n  transition: height 0.25s ease-in-out;\n  overflow: auto; }\n.workflowEditorMain .graphEditorRow.show-console {\n    height: calc(100vh - 470px); }\n.workflowEditorMain .graphEditorColumn {\n  height: 100%;\n  overflow: auto; }\n.workflowEditorMain .graphEditorColumn.graphArea {\n    overflow: hidden; }\n.workflowEditorMain .graphEditorActionPanel {\n  -webkit-box-flex: 0;\n  flex: 0 0 20%;\n  max-width: 20%; }\n.workflowEditorMain .playbook-heading {\n  cursor: pointer; }\n#playbookEditorTabs {\n  display: inline-block;\n  vertical-align: top;\n  height: 100%;\n  width: 100%;\n  position: inherit;\n  background: transparent; }\n#cy {\n  /* display: inline-block; */\n  /* vertical-align: top; */\n  width: 100%;\n  height: 100%; }\n/* Need to do this else panzoom appears above modals */\n#cy .cy-panzoom {\n  z-index: 10; }\n#cy-instructions {\n  padding: 20px;\n  font-size: 25px; }\n#cy-json-data {\n  background-color: white;\n  color: black;\n  font-weight: normal;\n  height: 630px;\n  width: 500px;\n  resize: none; }\n.workflowEditorMain #accordion .card-heading .card-title:after {\n  /* symbol for \"opening\" panels */\n  font: normal normal normal 14px/1 FontAwesome;\n  font-size: inherit;\n  text-rendering: auto;\n  content: \"\\f078\";\n  /* adjust as needed, taken from bootstrap.css */\n  float: right;\n  /* adjust as needed */\n  color: grey;\n  /* adjust as needed */ }\n.no-transition {\n  -webkit-transition: none !important;\n  transition: none !important; }\n.workflowEditorMain #accordion .card-heading.collapsed .card-title:after {\n  /* symbol for \"collapsed\" panels */\n  content: \"\\f054\";\n  /* adjust as needed, taken from bootstrap.css */ }\n.workflowEditorMain .card-default > .card-heading {\n  background-color: #eaf2f6;\n  font-weight: bolder; }\n.workflowEditorMain .parametersEditor input[type=checkbox].form-control {\n  width: 34px;\n  margin: 0 5px; }\n.workflowEditorMain .parametersEditor .form-group.argument {\n  margin-bottom: 5px;\n  padding: 5px; }\n.workflowEditorMain .parametersEditor .form-group.argument.odd {\n  background-color: #EEE; }\n.workflowEditorMain .parametersEditor .indent {\n  border-left: 3px solid #DDD;\n  border-top: 1px solid #DDD;\n  border-bottom: 1px solid #DDD;\n  padding: 5px 0 5px 15px;\n  margin-top: 5px;\n  margin-bottom: 5px; }\n.workflowEditorMain .parametersEditor .addBar {\n  margin-bottom: 10px; }\n.workflowEditorMain .parametersEditor .addBar button {\n  margin-top: 25px; }\n.workflowEditorMain .parametersEditor .propertyHeader {\n  margin-bottom: 5px; }\n.workflowEditorMain .parametersEditor .required {\n  color: crimson;\n  margin-left: 5px; }\n.workflowEditorMain .parametersEditor .CodeMirror {\n  color: #495057;\n  border: 1px solid #dee2e6;\n  border-radius: 0.25rem;\n  height: 10rem; }\n.workflowEditorMain .parametersEditor .CodeMirror-empty {\n  color: rgba(73, 80, 87, 0.65); }\n.workflowEditorMain .parametersEditor .CodeMirror-focused {\n  background-color: #fff;\n  border-color: #8bb8df;\n  outline: 0;\n  box-shadow: 0 0 0 0.2rem rgba(51, 122, 183, 0.25); }\n.workflowEditorMain ngx-datatable datatable-body datatable-body-row datatable-body-cell .datatable-body-cell-label {\n  white-space: initial; }\n#workflowsModal .workflowPanel a {\n  cursor: pointer; }\n#workflowsModal .card-heading h4 {\n  min-height: 30px; }\n#workflowsModal .importContainer {\n  margin-bottom: 5px; }\n#workflowsModal .importContainer h5 {\n  display: inline-block; }\n#workflowsModal .importPlaybookInput {\n  display: inline-block; }\n#workflowsModal > .modal-dialog {\n  max-width: 600px; }\n#workflowsModal .modal-title,\n#executionResultsModal .modal-title,\n#playbookAndWorkflowActionModal .modal-title {\n  display: inline-block; }\n#executionResultsModal > .modal-dialog {\n  max-width: 95%; }\n.bottom-panel .tab-content {\n  max-height: 0px;\n  height: 0px;\n  overflow-y: auto;\n  -webkit-transition: all 0.25s ease-in-out;\n  transition: all 0.25s ease-in-out; }\n.bottom-panel.show-console .tab-content {\n  max-height: 300px;\n  height: 300px; }\n.bottom-panel .nav-link {\n  padding: unset; }\n.bottom-panel .nav-link .console-tab {\n    padding: 0.5rem 1rem; }\n.bottom-panel #menu-tab {\n  border: unset; }\nbody ngb-popover-window.popover {\n  max-width: 400px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var RedirectGuard = /** @class */ (function () {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        if (!route.data['logout']) return [3 /*break*/, 2];
    ...
    RedirectGuard.ctorParameters = function () { return [
...
var RefreshTokenInterceptor = /** @class */ (function () {
    ...
    RefreshTokenInterceptor.prototype.intercept = function (req, next) {
        ...
        if (this.jwtInterceptor.isWhitelistedDomain(req) && !this.jwtInterceptor.isBlacklistedRoute(req) && this.authService.isAccessTokenExpired()) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(this.authService.getAccessTokenRefreshed())
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function () { return _this.jwtInterceptor.intercept(req, next); }));
        }
        else {
            return next.handle(req);
        }
    };
    RefreshTokenInterceptor.ctorParameters = function () { return [
        { type: _auth_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] },
        { type: _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_5__["JwtInterceptor"] }
    ]; };
...
/***/ "./src/app/reports/manage.reports.component.scss":
/*!*******************************************************!*\
  !*** ./src/app/reports/manage.reports.component.scss ***!
  \*******************************************************/
/*! no static exports found */
...
module.exports = ".manageReportMain {\n  padding: 10px 15px; }\n\n.manageReportMain .card-default > .card-heading {\n  background-color: #eaf2f6;\n  font-weight: bolder; }\n\n.gridster-container {\n  margin: auto; }\n\n.widget {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n          flex-direction: column;\n  height: 100%; }\n\n.widget-header {\n  flex-basis: content; }\n\n.widget-content {\n  -webkit-box-flex: 1;\n          flex: 1;\n  position: relative; }\n\n.widget-fullscreen {\n  overflow-y: scroll;\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  left: 0;\n  bottom: 0; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/reports/manage.reports.component.ts":
/*!*****************************************************!*\
  !*** ./src/app/reports/manage.reports.component.ts ***!
  \*****************************************************/
/*! exports provided: ManageReportsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ManageReportsComponent", function() { return ManageReportsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _models_report_reportWidget__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/report/reportWidget */ "./src/app/models/report/reportWidget.ts");
/* harmony import */ var _models_report_report__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/report/report */ "./src/app/models/report/report.ts");
...
/* harmony import */ var _widget_modal_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./widget.modal.component */ "./src/app/reports/widget.modal.component.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
...
var ManageReportsComponent = /** @class */ (function () {
    function ManageReportsComponent(reportService, toastrService, activeRoute, router, modalService, utils) {
        this.reportService = reportService;
        this.toastrService = toastrService;
        this.activeRoute = activeRoute;
        this.router = router;
        this.modalService = modalService;
        this.utils = utils;
        this.report = new _models_report_report__WEBPACK_IMPORTED_MODULE_4__["Report"]();
    ...
    ManageReportsComponent.prototype.ngOnInit = function () {
        ...
        this.activeRoute.params.subscribe(function (params) {
            if (params.reportId) {
                _this.existingReport = true;
                _this.reportService.getReportWithMetadata(params.reportId).then(function (report) {
                    _this.report = report;
                });
            }
            _this.initGrid();
    ...
    ManageReportsComponent.prototype.initGrid = function () {
        this.options = {
    ...
    ManageReportsComponent.prototype.getGridWidth = function () {
        return this.gridColumns * Math.ceil(this.gridColSize * 4 / 3 + this.gridGutterSize) + this.gridGutterSize + 'px';
    };
    ManageReportsComponent.prototype.getGridHeight = function () {
        return this.gridRows * Math.ceil(this.gridColSize * 3 / 4 + this.gridGutterSize) + this.gridGutterSize + 'px';
    };
    ManageReportsComponent.prototype.changedOptions = function () {
        this.options.api.optionsChanged();
    };
    ManageReportsComponent.prototype.editWidget = function ($event, widget) {
        $event.preventDefault();
        var modalRef = this.modalService.open(_widget_modal_component__WEBPACK_IMPORTED_MODULE_9__["WidgetModalComponent"]);
        modalRef.componentInstance.widget = widget;
    };
    ManageReportsComponent.prototype.removeWidget = function ($event, widget) {
        $event.preventDefault();
        this.report.widgets.splice(this.report.widgets.indexOf(widget), 1);
    };
    ManageReportsComponent.prototype.addWidget = function (type) {
        var _this = this;
        var widget;
        switch (type) {
            case "bar":
                widget = new _models_report_reportWidget__WEBPACK_IMPORTED_MODULE_3__["BarChartWidget"]();
                break;
            case "line":
                widget = new _models_report_reportWidget__WEBPACK_IMPORTED_MODULE_3__["LineChartWidget"]();
                break;
            case "pie":
                widget = new _models_report_reportWidget__WEBPACK_IMPORTED_MODULE_3__["PieChartWidget"]();
                break;
            case "text":
                widget = new _models_report_reportWidget__WEBPACK_IMPORTED_MODULE_3__["TextWidget"]();
                break;
            case "table":
                widget = new _models_report_reportWidget__WEBPACK_IMPORTED_MODULE_3__["TableWidget"]();
                break;
            case "kibana":
                widget = new _models_report_reportWidget__WEBPACK_IMPORTED_MODULE_3__["KibanaWidget"]();
                break;
        }
        var modalRef = this.modalService.open(_widget_modal_component__WEBPACK_IMPORTED_MODULE_9__["WidgetModalComponent"]);
        modalRef.componentInstance.widget = widget;
        ...
        modalRef.result.then(function (addedWidget) {
            _this.report.widgets.push(addedWidget);
        }).catch(function () { return null; });
    };
    ManageReportsComponent.prototype.save = function () {
        if (!this.report.name)
    ...
    ManageReportsComponent.prototype.delete = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var reportName;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.utils.confirm("Are you sure you want to delete this report?")];
                    case 1:
                        _a.sent();
    ...
    ManageReportsComponent.ctorParameters = function () { return [
    ...
    ManageReportsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'manage-reports-component',
            template: __webpack_require__(/*! raw-loader!./manage.reports.component.html */ "./node_modules/raw-loader/index.js!./src/app/reports/manage.reports.component.html"),
            styles: [__webpack_require__(/*! ./manage.reports.component.scss */ "./src/app/reports/manage.reports.component.scss")]
        })
...
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _models_report_report__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/report/report */ "./src/app/models/report/report.ts");
/* harmony import */ var _execution_execution_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../execution/execution.service */ "./src/app/execution/execution.service.ts");
/* harmony import */ var csvtojson__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! csvtojson */ "./node_modules/csvtojson/browser/browser.js");
/* harmony import */ var csvtojson__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(csvtojson__WEBPACK_IMPORTED_MODULE_7__);
...
var ReportService = /** @class */ (function () {
    function ReportService(http, utils, executionService) {
        var _this = this;
        this.http = http;
        this.utils = utils;
        this.executionService = executionService;
        this.reportsChange = new rxjs__WEBPACK_IMPORTED_MODULE_8__["Observable"](function (observer) {
            _this.observer = observer;
            _this.getReports().then(function (reports) { return _this.observer.next(reports); });
        });
    }
    ReportService.prototype.emitChange = function (data) {
        var _this = this;
        if (this.observer)
            this.getReports().then(function (reports) { return _this.observer.next(reports); });
        return data;
    };
    ReportService.prototype.newReport = function (report) {
        var _this = this;
        return this.http.post('api/dashboards', Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["classToPlain"])(report))
            .toPromise()
            .then(function (data) { return _this.emitChange(data); })
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["plainToClass"])(_models_report_report__WEBPACK_IMPORTED_MODULE_5__["Report"], data); })
            .catch(this.utils.handleResponseError);
    };
    ReportService.prototype.updateReport = function (report) {
        var _this = this;
        return this.http.put('api/dashboards', Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["classToPlain"])(report))
            .toPromise()
            .then(function (data) { return _this.emitChange(data); })
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_2__["plainToClass"])(_models_report_report__WEBPACK_IMPORTED_MODULE_5__["Report"], data); })
            .catch(this.utils.handleResponseError);
    ...
    ReportService.prototype.getReportWithMetadata = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var theReport;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getReport(id)];
                    case 1:
                        theReport = _a.sent();
                        return [4 /*yield*/, Promise.all(theReport.widgets.map(function (widget) { return _this.getWidgetMetadata(widget); }))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, theReport];
                }
            });
        });
    };
    ReportService.prototype.getWidgetMetadata = function (widget) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var options, workflowStatus, _a, nodeStatus, _b, _c;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                switch (_d.label) {
                    case 0:
                        options = widget.options;
                        if (!(options.workflow && options.execution && options.action)) return [3 /*break*/, 6];
                        if (!(options.execution == "latest")) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.executionService.getLatestExecution(options.workflow)];
                    case 1:
                        _a = _d.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.executionService.getWorkflowStatus(options.execution)];
                    case 3:
                        _a = _d.sent();
                        _d.label = 4;
                    case 4:
                        ...
                        if (!nodeStatus) return [3 /*break*/, 6];
                        _c = (_b = widget).setMetadata;
    ...
    ReportService.prototype.parseResult = function (result) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var headers;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                headers = [];
                return [2 /*return*/, csvtojson__WEBPACK_IMPORTED_MODULE_7__()
                        .fromString(result)
    ...
    ReportService.ctorParameters = function () { return [
        ...
        { type: _execution_execution_service__WEBPACK_IMPORTED_MODULE_6__["ExecutionService"] }
    ]; };
...
/* harmony import */ var _report_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./report.service */ "./src/app/reports/report.service.ts");
/* harmony import */ var angular_gridster2__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! angular-gridster2 */ "./node_modules/angular-gridster2/fesm5/angular-gridster2.js");
...
var ReportsComponent = /** @class */ (function () {
    function ReportsComponent(route, toastrService, http, reportService) {
        this.route = route;
        this.toastrService = toastrService;
        this.http = http;
        this.reportService = reportService;
    ...
    ReportsComponent.prototype.ngOnInit = function () {
        ...
        this.paramsSub = this.route.params.subscribe(function (params) {
            ...
            _this.getReport().then(function () { return _this.initGrid(); });
        });
    };
    ReportsComponent.prototype.initGrid = function () {
        var _this = this;
        this.gridRows = 0;
        this.report.widgets.forEach(function (item) {
            var widgetRows = item.y + item.rows;
            if (widgetRows > _this.gridRows)
                _this.gridRows = widgetRows;
        });
        this.options = {
            gridType: angular_gridster2__WEBPACK_IMPORTED_MODULE_7__["GridType"].Fixed,
            compactType: angular_gridster2__WEBPACK_IMPORTED_MODULE_7__["CompactType"].None,
            pushItems: true,
            draggable: {
                enabled: false
            },
    ...
    ReportsComponent.prototype.getReport = function () {
        var _this = this;
        this.clearReport();
        return this.reportService.getReportWithMetadata(this.reportId).then(function (savedReport) {
            (savedReport) ? _this.report = savedReport : _this.getCustomReport();
        });
    };
    ReportsComponent.prototype.clearReport = function () {
        this.report = null;
    ...
    ReportsComponent.prototype.getCustomReport = function () {
        var _this = this;
        this.http
            ...
            .catch(function (e) { return _this.toastrService.error("Error retrieving report: " + e.message); });
    };
    ReportsComponent.prototype.getGridWidth = function () {
        //return '900px';
        return this.gridColumns * Math.ceil(this.gridColSize * 4 / 3 + this.gridGutterSize) + this.gridGutterSize + 'px';
    };
    ReportsComponent.prototype.getGridHeight = function () {
        //return '980px';
        return this.gridRows * Math.ceil(this.gridColSize * 3 / 4 + this.gridGutterSize) + this.gridGutterSize + 'px';
    };
    ReportsComponent.prototype.savePDF = function () {
        return window.print();
    ...
    ReportsComponent.ctorParameters = function () { return [
        ...
        { type: _report_service__WEBPACK_IMPORTED_MODULE_6__["ReportService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('reportsMain', { static: true })
    ], ReportsComponent.prototype, "main", void 0);
    ReportsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'reports-component',
            template: __webpack_require__(/*! raw-loader!./reports.html */ "./node_modules/raw-loader/index.js!./src/app/reports/reports.html"),
            providers: [_auth_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]],
            styles: [__webpack_require__(/*! ./reports.scss */ "./src/app/reports/reports.scss")]
        })
    ], ReportsComponent);
...
module.exports = "#main.customReport {\n  position: absolute;\n  top: 50px;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  overflow: hidden; }\n\n#main.customReport iframe {\n  position: absolute;\n  border: none;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%; }\n\n#main.reportsMain {\n  padding: 10px 15px; }\n\ngridster.displayGrid {\n  background: none; }\n\n.widget {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n          flex-direction: column;\n  height: 100%; }\n\n.widget-header {\n  flex-basis: content; }\n\n.widget-content {\n  -webkit-box-flex: 1;\n          flex: 1;\n  position: relative; }\n\n.widget-fullscreen {\n  overflow-y: scroll !important;\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  left: 0;\n  bottom: 0; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/reports/widget.modal.component.scss":
/*!*****************************************************!*\
  !*** ./src/app/reports/widget.modal.component.scss ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3JlcG9ydHMvd2lkZ2V0Lm1vZGFsLmNvbXBvbmVudC5zY3NzIn0= */"

/***/ }),

/***/ "./src/app/reports/widget.modal.component.ts":
/*!***************************************************!*\
  !*** ./src/app/reports/widget.modal.component.ts ***!
  \***************************************************/
...
var WidgetModalComponent = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.executions = [{ id: 'latest', text: 'Latest' }].concat(workflowStatuses
                            .filter(function (status) { return status.workflow_id == workflowId && status.status == _models_execution_workflowStatus__WEBPACK_IMPORTED_MODULE_5__["WorkflowStatuses"].COMPLETED; })
    ...
    WidgetModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _execution_execution_service__WEBPACK_IMPORTED_MODULE_3__["ExecutionService"] },
        { type: _playbook_playbook_service__WEBPACK_IMPORTED_MODULE_4__["PlaybookService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ], WidgetModalComponent.prototype, "widget", void 0);
    WidgetModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'widget-modal-component',
            template: __webpack_require__(/*! raw-loader!./widget.modal.component.html */ "./node_modules/raw-loader/index.js!./src/app/reports/widget.modal.component.html"),
            styles: [__webpack_require__(/*! ./widget.modal.component.scss */ "./src/app/reports/widget.modal.component.scss")]
        })
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _playbook_playbook_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./playbook/playbook.component */ "./src/app/playbook/playbook.component.ts");
...
/* harmony import */ var _globals_globals_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./globals/globals.component */ "./src/app/globals/globals.component.ts");
...
/* harmony import */ var _execution_execution_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./execution/execution.component */ "./src/app/execution/execution.component.ts");
/* harmony import */ var _reports_manage_reports_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./reports/manage.reports.component */ "./src/app/reports/manage.reports.component.ts");
/* harmony import */ var _playbook_workflow_editor_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./playbook/workflow.editor.component */ "./src/app/playbook/workflow.editor.component.ts");
/* harmony import */ var _apps_apps_list_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./apps/apps.list.component */ "./src/app/apps/apps.list.component.ts");
/* harmony import */ var _apps_manage_app_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./apps/manage.app.component */ "./src/app/apps/manage.app.component.ts");
/* harmony import */ var _can_deactivate_guard__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./can-deactivate.guard */ "./src/app/can-deactivate.guard.ts");
/* harmony import */ var _redirect_guard__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./redirect.guard */ "./src/app/redirect.guard.ts");
...
var routes = [
    ...
    { path: 'workflows', component: _playbook_playbook_component__WEBPACK_IMPORTED_MODULE_3__["PlaybookComponent"] },
    { path: 'workflows/new', component: _playbook_workflow_editor_component__WEBPACK_IMPORTED_MODULE_10__["WorkflowEditorComponent"], canDeactivate: [_can_deactivate_guard__WEBPACK_IMPORTED_MODULE_13__["CanDeactivateGuard"]] },
    { path: 'workflows/:workflowId', component: _playbook_workflow_editor_component__WEBPACK_IMPORTED_MODULE_10__["WorkflowEditorComponent"], canDeactivate: [_can_deactivate_guard__WEBPACK_IMPORTED_MODULE_13__["CanDeactivateGuard"]] },
    { path: 'settings/scheduler', component: _scheduler_scheduler_component__WEBPACK_IMPORTED_MODULE_4__["SchedulerComponent"] },
    { path: 'settings/globals', component: _globals_globals_component__WEBPACK_IMPORTED_MODULE_5__["GlobalsComponent"] },
    { path: 'settings/users', component: _settings_settings_component__WEBPACK_IMPORTED_MODULE_6__["SettingsComponent"] },
    { path: 'execution', component: _execution_execution_component__WEBPACK_IMPORTED_MODULE_8__["ExecutionComponent"] },
    { path: 'apps', component: _apps_apps_list_component__WEBPACK_IMPORTED_MODULE_11__["AppsListComponent"] },
    { path: 'apps/:appId', component: _apps_manage_app_component__WEBPACK_IMPORTED_MODULE_12__["ManageAppComponent"], canDeactivate: [_can_deactivate_guard__WEBPACK_IMPORTED_MODULE_13__["CanDeactivateGuard"]] },
    { path: 'report/new', component: _reports_manage_reports_component__WEBPACK_IMPORTED_MODULE_9__["ManageReportsComponent"] },
    { path: 'report/:reportId/edit', component: _reports_manage_reports_component__WEBPACK_IMPORTED_MODULE_9__["ManageReportsComponent"] },
    { path: 'report/:reportId', component: _reports_reports_component__WEBPACK_IMPORTED_MODULE_7__["ReportsComponent"] },
    { path: 'logout', canActivate: [_redirect_guard__WEBPACK_IMPORTED_MODULE_14__["RedirectGuard"]], component: _redirect_guard__WEBPACK_IMPORTED_MODULE_14__["RedirectGuard"], data: { externalUrl: '/walkoff/login', logout: true } }
];
...
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
/* harmony import */ var rxjs_add_operator_debounceTime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/add/operator/debounceTime */ "./node_modules/rxjs-compat/_esm5/add/operator/debounceTime.js");
/* harmony import */ var _scheduler_modal_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./scheduler.modal.component */ "./src/app/scheduler/scheduler.modal.component.ts");
...
var SchedulerComponent = /** @class */ (function () {
    ...
    SchedulerComponent.prototype.addScheduledTask = function () {
        var modalRef = this.modalService.open(_scheduler_modal_component__WEBPACK_IMPORTED_MODULE_6__["SchedulerModalComponent"], { size: 'lg' });
    ...
    SchedulerComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./scheduler.html */ "./node_modules/raw-loader/index.js!./src/app/scheduler/scheduler.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
            providers: [_scheduler_service__WEBPACK_IMPORTED_MODULE_7__["SchedulerService"]],
...
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
/* harmony import */ var _models_scheduler_scheduledTask__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../models/scheduler/scheduledTask */ "./src/app/models/scheduler/scheduledTask.ts");
/* harmony import */ var _models_scheduler_scheduledTaskCron__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../models/scheduler/scheduledTaskCron */ "./src/app/models/scheduler/scheduledTaskCron.ts");
/* harmony import */ var _models_scheduler_scheduledTaskInterval__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../models/scheduler/scheduledTaskInterval */ "./src/app/models/scheduler/scheduledTaskInterval.ts");
/* harmony import */ var _models_scheduler_scheduledTaskDate__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../models/scheduler/scheduledTaskDate */ "./src/app/models/scheduler/scheduledTaskDate.ts");
...
var SchedulerModalComponent = /** @class */ (function () {
    function SchedulerModalComponent(schedulerService, activeModal, toastrService) {
        ...
        this.activeModal = activeModal;
        this.toastrService = toastrService;
        this.workingScheduledTask = new _models_scheduler_scheduledTask__WEBPACK_IMPORTED_MODULE_7__["ScheduledTask"]();
        this.availableWorkflows = [];
        this.scheduledItemTriggerTypes = ['date', 'interval', 'cron'];
        this.cron = new _models_scheduler_scheduledTaskCron__WEBPACK_IMPORTED_MODULE_8__["ScheduledTaskCron"]();
        this.interval = new _models_scheduler_scheduledTaskInterval__WEBPACK_IMPORTED_MODULE_9__["ScheduledTaskInterval"]();
        this.date = new _models_scheduler_scheduledTaskDate__WEBPACK_IMPORTED_MODULE_10__["ScheduledTaskDate"]();
    }
    /**
    ...
    SchedulerModalComponent.prototype.getToday = function () {
        return moment__WEBPACK_IMPORTED_MODULE_4__().format('YYYY-MM-DD');
    };
    /**
    ...
    SchedulerModalComponent.prototype.convertStringsToInt = function (args) {
        ...
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](Object.entries(args)), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    SchedulerModalComponent.ctorParameters = function () { return [
        { type: _scheduler_service__WEBPACK_IMPORTED_MODULE_5__["SchedulerService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    SchedulerModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'scheduler-modal',
            template: __webpack_require__(/*! raw-loader!./scheduler.modal.html */ "./node_modules/raw-loader/index.js!./src/app/scheduler/scheduler.modal.html"),
            providers: [_scheduler_service__WEBPACK_IMPORTED_MODULE_5__["SchedulerService"], _utilities_service__WEBPACK_IMPORTED_MODULE_6__["UtilitiesService"]],
...
module.exports = "/* @import '/client/node_modules/ng-pick-datetime/styles/picker.min.css'; */\n.schedulerMain {\n  padding: 10px 15px; }\n.schedulerMain #schedulerStatus {\n  display: inline-block; }\n.schedulerMain ngx-datatable datatable-body datatable-body-row datatable-body-cell .datatable-body-cell-label {\n  white-space: initial; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
/* harmony import */ var _models_playbook_workflow__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../models/playbook/workflow */ "./src/app/models/playbook/workflow.ts");
...
var SchedulerService = /** @class */ (function () {
    ...
    SchedulerService.prototype.getScheduledTasks = function (page) {
        ...
        return this.http.get("api/scheduledtasks?page=" + page)
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_5__["plainToClass"])(_models_scheduler_scheduledTask__WEBPACK_IMPORTED_MODULE_6__["ScheduledTask"], data); })
            .catch(this.utils.handleResponseError);
    };
    ...
    SchedulerService.prototype.getWorkflows = function () {
        return this.http.get('api/workflows')
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_5__["plainToClass"])(_models_playbook_workflow__WEBPACK_IMPORTED_MODULE_8__["Workflow"], data); })
            .catch(this.utils.handleResponseError);
    };
...
/* harmony import */ var _settings_user_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./settings.user.modal.component */ "./src/app/settings/settings.user.modal.component.ts");
/* harmony import */ var _models_configuration__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../models/configuration */ "./src/app/models/configuration.ts");
/* harmony import */ var _models_workingUser__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../models/workingUser */ "./src/app/models/workingUser.ts");
/* harmony import */ var _settings_timeout_modal_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./settings.timeout.modal.component */ "./src/app/settings/settings.timeout.modal.component.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
...
var SettingsComponent = /** @class */ (function () {
    function SettingsComponent(settingsService, modalService, toastrService, utils) {
        ...
        this.toastrService = toastrService;
        this.utils = utils;
        this.configuration = new _models_configuration__WEBPACK_IMPORTED_MODULE_8__["Configuration"]();
    ...
    SettingsComponent.prototype.resetConfiguration = function () {
        ...
        Object.assign(this.configuration, _models_configuration__WEBPACK_IMPORTED_MODULE_8__["Configuration"].getDefaultConfiguration());
    };
    ...
    SettingsComponent.prototype.addUser = function () {
        var modalRef = this.modalService.open(_settings_user_modal_component__WEBPACK_IMPORTED_MODULE_7__["SettingsUserModalComponent"]);
        modalRef.componentInstance.title = 'Add New User';
        modalRef.componentInstance.submitText = 'Add User';
        modalRef.componentInstance.roles = this.roles;
        var workingUser = new _models_workingUser__WEBPACK_IMPORTED_MODULE_9__["WorkingUser"]();
    ...
    SettingsComponent.prototype.editTimeout = function () {
        var _this = this;
        var modalRef = this.modalService.open(_settings_timeout_modal_component__WEBPACK_IMPORTED_MODULE_10__["SettingsTimeoutModalComponent"]);
    ...
    SettingsComponent.prototype.editUser = function (user) {
        ...
        modalRef.componentInstance.submitText = 'Save Changes';
        modalRef.componentInstance.roles = this.roles;
        modalRef.componentInstance.workingUser = _models_workingUser__WEBPACK_IMPORTED_MODULE_9__["WorkingUser"].fromUser(user);
        this._handleModalClose(modalRef);
    };
    ...
    SettingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./settings.html */ "./node_modules/raw-loader/index.js!./src/app/settings/settings.html"),
            providers: [_settings_service__WEBPACK_IMPORTED_MODULE_6__["SettingsService"]],
...
/* harmony import */ var _settings_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./settings.service */ "./src/app/settings/settings.service.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
/* harmony import */ var _settings_roles_modal_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./settings.roles.modal.component */ "./src/app/settings/settings.roles.modal.component.ts");
/* harmony import */ var _models_role__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../models/role */ "./src/app/models/role.ts");
...
var SettingsRolesComponent = /** @class */ (function () {
    ...
    SettingsRolesComponent.prototype.addRole = function () {
        var modalRef = this.modalService.open(_settings_roles_modal_component__WEBPACK_IMPORTED_MODULE_8__["SettingsRoleModalComponent"]);
        ...
        modalRef.componentInstance.workingRole = new _models_role__WEBPACK_IMPORTED_MODULE_9__["Role"]();
        this._handleModalClose(modalRef);
    };
    ...
    SettingsRolesComponent.ctorParameters = function () { return [
        { type: _settings_service__WEBPACK_IMPORTED_MODULE_6__["SettingsService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"] },
        { type: _utilities_service__WEBPACK_IMPORTED_MODULE_7__["UtilitiesService"] }
    ]; };
    SettingsRolesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'settings-roles-component',
            template: __webpack_require__(/*! raw-loader!./settings.roles.html */ "./node_modules/raw-loader/index.js!./src/app/settings/settings.roles.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
            providers: [_settings_service__WEBPACK_IMPORTED_MODULE_6__["SettingsService"]],
            styles: [__webpack_require__(/*! ./settings.scss */ "./src/app/settings/settings.scss")]
        })
...
var SettingsRoleModalComponent = /** @class */ (function () {
    ...
    SettingsRoleModalComponent.ctorParameters = function () { return [
    ...
    SettingsRoleModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'settings-role-modal',
            template: __webpack_require__(/*! raw-loader!./settings.roles.modal.html */ "./node_modules/raw-loader/index.js!./src/app/settings/settings.roles.modal.html"),
            providers: [_settings_service__WEBPACK_IMPORTED_MODULE_4__["SettingsService"], _utilities_service__WEBPACK_IMPORTED_MODULE_5__["UtilitiesService"]],
            styles: [__webpack_require__(/*! ./settings.scss */ "./src/app/settings/settings.scss")]
        })
...
module.exports = ".settingsMain {\n  padding: 10px 15px; }\n\n.settingsMain ngx-datatable datatable-body datatable-body-row datatable-body-cell .datatable-body-cell-label {\n  white-space: initial; }\n\n#roleModalBody .resourceGroup {\n  padding: 5px; }\n\n#roleModalBody .resourceGroup.odd {\n  background-color: #EEE; }\n\n#roleModalBody .resourceGroup .row {\n  padding-bottom: 5px; }\n\n#roleModalBody .required,\n#userModalBody .required {\n  color: crimson;\n  margin-left: 5px; }\n\n.settingsMain input[type=checkbox].form-control,\n.settingsMain input[type=radio].form-control,\n#userModalBody input[type=checkbox].form-control,\n#userModalBody input[type=radio].form-control {\n  width: 34px;\n  margin: 0 5px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _models_availableResourceAction__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../models/availableResourceAction */ "./src/app/models/availableResourceAction.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
...
var SettingsService = /** @class */ (function () {
    ...
    SettingsService.prototype.getConfiguration = function () {
        return this.http.get('api/settings')
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["plainToClass"])(_models_configuration__WEBPACK_IMPORTED_MODULE_4__["Configuration"], data); })
            .catch(this.utils.handleResponseError);
    };
    ...
    SettingsService.prototype.getUsers = function (page) {
        ...
        return this.http.get("api/users?page=" + page)
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["plainToClass"])(_models_user__WEBPACK_IMPORTED_MODULE_5__["User"], data); })
            .catch(this.utils.handleResponseError);
    };
    ...
    SettingsService.prototype.getRoles = function () {
        return this.http.get('api/roles')
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["plainToClass"])(_models_role__WEBPACK_IMPORTED_MODULE_6__["Role"], data); })
            .catch(this.utils.handleResponseError);
    };
    ...
    SettingsService.prototype.getAvailableResourceActions = function () {
        ...
        return this.http.get('api/availableresourceactions')
            .toPromise()
            .then(function (data) { return Object(class_transformer__WEBPACK_IMPORTED_MODULE_3__["plainToClass"])(_models_availableResourceAction__WEBPACK_IMPORTED_MODULE_7__["AvailableResourceAction"], data); })
            .catch(this.utils.handleResponseError);
    };
...
var SettingsTimeoutModalComponent = /** @class */ (function () {
    ...
    SettingsTimeoutModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ], SettingsTimeoutModalComponent.prototype, "configuration", void 0);
    SettingsTimeoutModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'timeout-modal',
            template: __webpack_require__(/*! raw-loader!./settings.timeout.modal.html */ "./node_modules/raw-loader/index.js!./src/app/settings/settings.timeout.modal.html"),
...
/* harmony import */ var _settings_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./settings.service */ "./src/app/settings/settings.service.ts");
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utilities.service */ "./src/app/utilities.service.ts");
/* harmony import */ var _models_workingUser__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/workingUser */ "./src/app/models/workingUser.ts");
...
var SettingsUserModalComponent = /** @class */ (function () {
    ...
    SettingsUserModalComponent.prototype.submit = function () {
        ...
        var toSubmit = _models_workingUser__WEBPACK_IMPORTED_MODULE_6__["WorkingUser"].toUser(this.workingUser);
    ...
    SettingsUserModalComponent.ctorParameters = function () { return [
        { type: _settings_service__WEBPACK_IMPORTED_MODULE_4__["SettingsService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"] }
    ]; };
    ...
    SettingsUserModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'user-modal',
            template: __webpack_require__(/*! raw-loader!./settings.user.modal.html */ "./node_modules/raw-loader/index.js!./src/app/settings/settings.user.modal.html"),
            providers: [_settings_service__WEBPACK_IMPORTED_MODULE_4__["SettingsService"], _utilities_service__WEBPACK_IMPORTED_MODULE_5__["UtilitiesService"]],
            styles: [__webpack_require__(/*! ./settings.scss */ "./src/app/settings/settings.scss")]
        })
...
var UtilitiesService = /** @class */ (function () {
    ...
    UtilitiesService.prototype.getCurrentIsoString = function () {
        return moment__WEBPACK_IMPORTED_MODULE_3__["utc"]().toISOString();
    };
    /**
    ...
    UtilitiesService.prototype.getLocalTime = function (time) {
        return moment__WEBPACK_IMPORTED_MODULE_3__["utc"](time).local().toLocaleString();
    };
    /**
    ...
    UtilitiesService.prototype.getRelativeLocalTime = function (time) {
        return moment__WEBPACK_IMPORTED_MODULE_3__["utc"](time).local().fromNow();
    };
    /**
    ...
    UtilitiesService.prototype.confirm = function (message, options) {
        ...
        return new Promise(function (resolve) {
            var defaults = {
                ...
                backdrop: true,
                className: "mt-5 pt-5",
                callback: function (result) { if (result || options.alwaysResolve)
                    resolve(result); }
            };
...
module.exports = __webpack_require__(/*! C:\Users\602646\Code\walkoff\WALKOFF\api_gateway\client\src\main.ts */"./src/main.ts");
