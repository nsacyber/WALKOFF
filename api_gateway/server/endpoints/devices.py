...
from api_gateway.appgateway.apiutil import UnknownApp, UnknownDevice, InvalidParameter
from api_gateway.appgateway.validator import validate_device_fields
...
__device_error_messages = {UnknownApp: ('App does not exist', 'Unknown app.'),
                           ...
                           InvalidParameter: ('Invalid input', 'Invalid device fields.')}
