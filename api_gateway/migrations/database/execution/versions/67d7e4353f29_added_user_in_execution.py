...
def upgrade():
    ...
    with op.batch_alter_table('action', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_action_workflow_id_workflow'), 'workflow', ['workflow_id'], ['id'],
                                    ondelete='CASCADE')

    with op.batch_alter_table('action_metric', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_action_metric_app_metric_id_app_metric'), 'app_metric',
                                    ['app_metric_id'], ['id'], ondelete='CASCADE')

    with op.batch_alter_table('action_status', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_action_status__workflow_status_id_workflow_status'),
                                    'workflow_status', ['_workflow_status_id'], ['execution_id'], ondelete='CASCADE')

    with op.batch_alter_table('action_status_metric', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_action_status_metric_action_metric_id_action_metric'),
                                    'action_metric', ['action_metric_id'], ['id'], ondelete='CASCADE')

    with op.batch_alter_table('argument', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_argument_action_id_action'), 'action', ['action_id'], ['id'],
                                    ondelete='CASCADE')
        batch_op.create_foreign_key(batch_op.f('fk_argument_condition_id_condition'), 'condition', ['condition_id'],
                                    ['id'], ondelete='CASCADE')
        batch_op.create_foreign_key(batch_op.f('fk_argument_transform_id_transform'), 'transform', ['transform_id'],
                                    ['id'], ondelete='CASCADE')
        batch_op.create_foreign_key(batch_op.f('fk_argument_action_device_id_action'), 'action', ['action_device_id'],
                                    ['id'], ondelete='CASCADE')

    with op.batch_alter_table('branch', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_branch_workflow_id_workflow'), 'workflow', ['workflow_id'], ['id'],
                                    ondelete='CASCADE')

    with op.batch_alter_table('condition', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_condition_conditional_expression_id_conditional_expression'),
                                    'conditional_expression', ['conditional_expression_id'], ['id'], ondelete='CASCADE')

    with op.batch_alter_table('conditional_expression', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_conditional_expression_branch_id_branch'), 'branch', ['branch_id'],
                                    ['id'], ondelete='CASCADE')
        batch_op.create_foreign_key(batch_op.f('fk_conditional_expression_action_id_action'), 'action', ['action_id'],
                                    ['id'], ondelete='CASCADE')
        batch_op.create_foreign_key(batch_op.f('fk_conditional_expression_parent_id_conditional_expression'),
                                    'conditional_expression', ['parent_id'], ['id'], ondelete='CASCADE')
    ...
    with op.batch_alter_table('encrypted_device_field', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_encrypted_device_field_device_id_device'), 'device', ['device_id'],
                                    ['id'], ondelete='CASCADE')

    with op.batch_alter_table('plaintext_device_field', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_plaintext_device_field_device_id_device'), 'device', ['device_id'],
                                    ['id'], ondelete='CASCADE')
    ...
    with op.batch_alter_table('position', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_position_action_id_action'), 'action', ['action_id'], ['id'],
                                    ondelete='CASCADE')
    ...
    with op.batch_alter_table('transform', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_transform_condition_id_condition'), 'condition', ['condition_id'],
                                    ['id'], ondelete='CASCADE')

    with op.batch_alter_table('workflow', schema=None) as batch_op:
        batch_op.create_foreign_key(batch_op.f('fk_workflow_playbook_id_playbook'), 'playbook', ['playbook_id'], ['id'],
                                    ondelete='CASCADE')
...
def downgrade():
    ...
    with op.batch_alter_table('conditional_expression', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('fk_conditional_expression_parent_id_conditional_expression'),
                                 type_='foreignkey')
    ...
    with op.batch_alter_table('condition', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('fk_condition_conditional_expression_id_conditional_expression'),
                                 type_='foreignkey')
    ...
    with op.batch_alter_table('action_status_metric', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('fk_action_status_metric_action_metric_id_action_metric'),
                                 type_='foreignkey')
