...
def upgrade():
    ...
    op.create_table('saved_workflow',
                    sa.Column('workflow_execution_id', sqlalchemy_utils.types.uuid.UUIDType(binary=False),
                              nullable=False),
    ...
    op.create_table('workflow_status',
                    ...
                    sa.Column('status', sa.Enum('pending', 'running', 'paused', 'awaiting_data', 'completed', 'aborted',
                                                name='workflowstatusenum'), nullable=False),
    ...
    op.create_table('action_status',
                    ...
                    sa.Column('status', sa.Enum('executing', 'awaiting_data', 'success', 'failure', 'aborted',
                                                name='actionstatusenum'), nullable=False),
                    sa.Column('started_at', sa.DateTime(), nullable=True),
                    sa.Column('completed_at', sa.DateTime(), nullable=True),
    ...
    op.create_table('condition',
                    sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), nullable=False),
                    sa.Column('conditional_expression_id', sqlalchemy_utils.types.uuid.UUIDType(binary=False),
                              nullable=True),
                    sa.Column('app_name', sa.String(length=80), nullable=False),
                    sa.Column('action_name', sa.String(length=80), nullable=False),
                    sa.Column('is_negated', sa.Boolean(), nullable=True),
