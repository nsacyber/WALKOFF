...
class Resource(Base, TrackModificationsMixIn):
    ...
    permissions = relationship('Permission', backref=backref('resource'), cascade='all, delete-orphan')
    operations = relationship('Operation', backref=backref('resource'), cascade='all, delete-orphan')
...
class Operation(Base):
    ...
    permissions_list = Column(ARRAY(String(255)))
