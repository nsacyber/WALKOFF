...
def upgrade():
    ...
    sa.Column('workflow_execution_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    sa.Column('workflow_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    sa.Column('action_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    ...
    sa.Column('execution_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    sa.Column('workflow_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    ...
    sa.Column('started_at', sa.DateTime(), nullable=True),
    sa.Column('completed_at', sa.DateTime(), nullable=True),
    sa.Column('_workflow_status_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
    sa.ForeignKeyConstraint(['_workflow_status_id'], ['workflow_status.execution_id'], ),
    sa.PrimaryKeyConstraint('execution_id')
    )
    op.create_table('workflow',
    sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    sa.Column('playbook_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
    sa.Column('name', sa.String(length=80), nullable=False),
    sa.Column('start', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
    ...
    sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    sa.Column('workflow_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
    sa.Column('source_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    sa.Column('destination_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    ...
    sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    sa.Column('action_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
    sa.Column('branch_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
    ...
    sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    sa.Column('conditional_expression_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
    sa.Column('app_name', sa.String(length=80), nullable=False),
    sa.Column('action_name', sa.String(length=80), nullable=False),
    sa.Column('is_negated', sa.Boolean(), nullable=True),
    ...
    sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    sa.Column('condition_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
    sa.Column('app_name', sa.String(length=80), nullable=False),
    sa.Column('action_name', sa.String(length=80), nullable=False),
    ...
    sa.Column('action_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
    sa.Column('condition_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
    sa.Column('transform_id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('value', sqlalchemy_utils.types.json.JSONType(), nullable=True),
    sa.Column('reference', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
